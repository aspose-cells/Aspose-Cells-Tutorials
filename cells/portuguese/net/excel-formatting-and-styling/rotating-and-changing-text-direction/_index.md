...
description: Transforme a direção do texto no Excel com Aspose.Cells para .NET. Siga nosso guia passo a passo para girar e ajustar o texto facilmente.
weight: 22
...
2.  Biblioteca Aspose.Cells: Você precisará da biblioteca Aspose.Cells para .NET. Você pode baixá-la do[site](https://releases.aspose.com/cells/net/).
...
```
 ...
 O`Worksheet` objeto refere-se à primeira planilha em sua pasta de trabalho. Você pode acessar outras planilhas alterando o índice.
