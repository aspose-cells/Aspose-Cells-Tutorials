...
```
Po wydrukowaniu ustawień wyświetli się komunikat informujący o powodzeniu programu, który potwierdzi, że wszystko przebiegło bez problemów.
## Wniosek
tym samouczku omówiliśmy, jak sprawdzić, czy ustawienie rozmiaru papieru arkuszy kalkulacyjnych w plikach programu Excel jest ustawione na automatyczne, korzystając z Aspose.Cells dla .NET. Postępując zgodnie z tymi krokami, posiadasz teraz podstawowe umiejętności, aby z łatwością manipulować plikami programu Excel programowo i sprawdzać określone konfiguracje, takie jak rozmiar papieru. 
