...
4. Plik Excela: Powinieneś mieć istniejący plik Excela, z którym możesz pracować. W tym samouczku użyjemy pliku o nazwie `book1.xls`. Umieść to w swoim projekcie lub katalogu, w którym będziesz pracować.
...
```
Zastępować `"Your Document Directory"` z rzeczywistą ścieżką, którą masz `book1.xls` przechowywane. Może to być ścieżka lokalnego dysku lub lokalizacja sieciowa, po prostu upewnij się, że jest poprawna.
