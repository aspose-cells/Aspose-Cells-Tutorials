...
1. Aspose.Cells for .NET Library – Upewnij się, że masz ją zainstalowaną. Możesz [pobierz bibliotekę tutaj](https://releases.aspose.com/cells/net/).
...
```csharp
workbook.Ustawienies.ShowTabs = true;
```

Setting `ShowTabs` Do `true` zapewni, że karty będą widoczne po otwarciu pliku Excel.
...
### Czy muszę mieć zainstalowany na swoim komputerze program Microsoft Excel, aby korzystać z Aspose.Cells?
