...
# Ustawienia wyświetlania programu Excel
...
| Tytuł | Opis |
| --- | --- |
| [Szerokość paska karty kontrolnej arkusza kalkulacyjnego](./control-tab-bar-width-of-spreadsheet/) | Dowiedz się, jak kontrolować szerokość paska kart arkusza w programie Excel przy użyciu Aspose.Cells dla .NET, korzystając z tego samouczka krok po kroku. Dostosuj pliki programu Excel w wydajny sposób. |  
...
| [Wyświetl i ukryj paski przewijania arkusza kalkulacyjnego](./display-and-hide-scroll-bars-of-worksheet/) | Wyświetlanie lub ukrywanie pasków przewijania w arkuszu kalkulacyjnym programu Excel przy użyciu Aspose.Cells dla platformy .NET. |  
...
| [Arkusz roboczy „Ukryj i pokaż”](./hide-and-unhide-worksheet/) | Opanuj manipulowanie arkuszami kalkulacyjnymi programu Excel dzięki temu kompletnemu przewodnikowi po ukrywaniu i pokazywaniu arkuszy za pomocą Aspose.Cells dla .NET. Usprawnij zarządzanie danymi. |  
| [Ukryj zakładki arkusza kalkulacyjnego](./hide-tabs-of-spreadsheet/) | Ukryj karty w arkuszu kalkulacyjnym programu Excel za pomocą Aspose.Cells dla .NET. Dowiedz się, jak programowo ukrywać i wyświetlać karty arkusza w zaledwie kilku prostych krokach. |  
