...
1. Utwórz nowy projekt: Otwórz program Visual Studio, utwórz nowy projekt aplikacji konsoli i nadaj mu opisową nazwę, np. `HideExcelTabs`.
...
Alternatywnie, jeśli pracujesz w trybie offline, możesz [pobierz Aspose.Cells dla .NET](https://releases.aspose.com/cells/net/) ręcznie dodaj plik DLL do odniesień swojego projektu.
...
Tutaj zapisujemy zmodyfikowany skoroszyt jako `output.xls` tym samym katalogu. Możesz nazwać plik jak chcesz.
