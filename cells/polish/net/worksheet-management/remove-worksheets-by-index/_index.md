...
```
Zastępować `"Your Document Directory"` z rzeczywistą ścieżką do Twoich plików. Ta zmienna będzie używana w całym kodzie do otwierania i zapisywania plików Excel.
