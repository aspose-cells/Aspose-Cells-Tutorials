...
```
 tym kodzie celujemy w komórki`A1` i wyprowadzając jego wartość do konsoli. Jest to pomocne w weryfikacji, ponieważ pozwala sprawdzić, czy wartość odpowiada temu, czego oczekujesz od pliku.
## Wniosek
