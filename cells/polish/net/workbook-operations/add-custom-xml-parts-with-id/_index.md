...
## Importuj pakiety
Aby użyć Aspose.Cells, musisz dodać wymaganą przestrzeń nazw na górze swojego kodu. Oto jak to zrobić:
```csharp
using System;
