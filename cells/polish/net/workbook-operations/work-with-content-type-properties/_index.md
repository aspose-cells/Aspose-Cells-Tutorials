...
- Biblioteka Aspose.Cells: Będziesz potrzebować Aspose.Cells dla .NET. Możesz ją łatwo pobrać ze strony [link do pobrania tutaj](https://releases.aspose.com/cells/net/).
...
Gdy już to zrobisz, czas na kodowanie!
## Krok 1: Konfigurowanie projektu
Zacznijmy od utworzenia katalogu wyjściowego, w którym będziemy zapisywać plik Excela.
```csharp
...
```
Ten fragment kodu dodaje nową właściwość z kluczem `"MK32"` i ustawia jego wartość na bieżącą datę i godzinę sformatowaną w określony sposób. Tutaj, `IsNillable` jest ustawiony na `true`, co oznacza, że nie ma problemu, jeśli to pole pozostanie puste. Pomyśl o tym jak o tworzeniu pola opcjonalnego w ankiecie.
...
```
Ta linijka kodu drukuje komunikat o powodzeniu na konsoli, zapewniając, że wszystko przebiegło gładko. To jak wisienka na torcie Twoich lodów!
## Wniosek
