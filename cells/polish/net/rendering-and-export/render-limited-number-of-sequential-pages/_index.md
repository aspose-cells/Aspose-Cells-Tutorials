...
Na koniec przejrzyjmy każdą określoną stronę i zapiszmy ją jako obraz. Ta pętla obsługuje renderowanie każdej strony i zapisywanie jej pod unikalną nazwą.
```csharp
...
W przypadku dużych plików warto rozważyć podzielenie renderowania na mniejsze sekcje, aby efektywnie zarządzać wykorzystaniem pamięci.
