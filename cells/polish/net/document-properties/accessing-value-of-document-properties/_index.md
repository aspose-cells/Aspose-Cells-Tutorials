---
title: Uzyskiwanie dostępu do wartości właściwości dokumentu w .NET
linktitle: Uzyskiwanie dostępu do wartości właściwości dokumentu w .NET
...
# Uzyskiwanie dostępu do wartości właściwości dokumentu w .NET
...
Teraz zajrzyjmy do kolekcji właściwości i chwyćmy konkretną właściwość dokumentu. W tym przykładzie uzyskamy dostęp do pierwszej niestandardowej właściwości.
```csharp
Aspose.Cells.Properties.DocumentProperty customProperty1 = customProperties[0];
object objectValue = customProperty1.Value;
```
Tutaj pobieramy pierwszą właściwość i przechowujemy jej wartość. Może to być cokolwiek od ciągu do liczby, w zależności od tego, co zostało wprowadzone.
