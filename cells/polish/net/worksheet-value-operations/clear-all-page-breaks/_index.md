...
2. Licencja Aspose: Aby uzyskać pełną funkcjonalność poza ograniczeniami wersji próbnej, możesz chcieć zastosować licencję. Możesz uzyskać [licencja tymczasowa](https://purchase.aspose.com/tempLubary-license/) or [kupić licencję](https://purchase.aspose.com/buy).
...
### Czy mogę usunąć podziały stron w wielu arkuszach kalkulacyjnych jednocześnie?  
