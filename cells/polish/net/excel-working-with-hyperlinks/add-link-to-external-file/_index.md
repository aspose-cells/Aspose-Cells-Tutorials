...
```
Zastępować `"Your Document Directory"` z rzeczywistą ścieżką, w której chcesz przechowywać pliki. To tak, jakbyś wybrał właściwy folder, aby zachować porządek w dokumentach, dzięki czemu łatwiej będzie je później znaleźć!
...
Teraz czas na zabawę: dodanie hiperłącza! Pozwala to na linkowanie do pliku zewnętrznego, np. innego dokumentu Excel.
```csharp
