...
```
Ten krok umożliwia konwersję danych CSV do w pełni funkcjonalnego skoroszytu programu Excel, a każda wartość jest analizowana zgodnie z preferowanymi przez Ciebie regułami.
