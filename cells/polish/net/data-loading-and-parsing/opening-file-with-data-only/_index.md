...
2. Visual Studio: To jest IDE, w którym będziesz pisać i uruchamiać swój kod. Jeśli jeszcze go nie zainstalowałeś, to teraz jest na to świetny moment!
...
Najpierw musisz określić, gdzie znajduje się plik Excel. To tak, jakbyś powiedział swojemu GPS-owi, gdzie ma nawigować — jeśli nie ustawisz celu, nigdzie nie dotrzesz!
```csharp
