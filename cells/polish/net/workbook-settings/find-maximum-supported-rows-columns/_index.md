...
Tak, biblioteka Aspose.Cells for .NET obsługuje szeroki zakres formatów plików Excel, w tym XLS, XLSX, ODS i inne. Możesz eksplorować [dokumentacja](https://reference.aspose.com/cells/net/) aby dowiedzieć się więcej o dostępnych funkcjach i funkcjonalnościach.
