...
## Importuj pakiety
Aby pracować z Aspose.Cells w swoim projekcie, musisz uwzględnić niezbędne przestrzenie nazw. Poniższe polecenia importu powinny zostać umieszczone na górze kodu:
```csharp
using System.IO;
using Aspose.Cells;
...
```
Te przestrzenie nazw zapewniają dostęp do podstawowej funkcjonalności Aspose.Cells i umożliwiają manipulowanie arkuszami kalkulacyjnymi i kształtami.

## Przewodnik krok po kroku, jak uzyskać punkty połączeń kształtu
W tej sekcji przeprowadzimy Cię przez proces wyodrębniania punktów połączeń kształtu w arkuszu kalkulacyjnym programu Excel. Dokładnie wykonaj każdy krok, aby uzyskać jasne zrozumienie.
...
- Ustaw wymiary pola tekstowego na `160` jednostki szerokości i `200` jednostek wysokości.
...
## Wniosek
tym samouczku omówiliśmy, jak pobrać punkty połączeń kształtu w programie Excel przy użyciu Aspose.Cells dla .NET. Dzieląc zadanie na małe, przyswajalne kroki, zbadaliśmy proces tworzenia skoroszytu, dodawania kształtu i wyodrębniania punktów połączeń.
