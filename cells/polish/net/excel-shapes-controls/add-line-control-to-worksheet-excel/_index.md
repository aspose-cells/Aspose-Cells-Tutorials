...
## Importuj pakiety
Przygotujmy środowisko kodowania, zanim zaczniemy dodawać wiersze do arkusza kalkulacyjnego programu Excel. Oto, jak zaimportować wymagany pakiet Aspose.Cells do projektu.
### Utwórz nowy projekt
...
Możesz uzyskać wsparcie od [Forum Aspose](https://forum.aspose.com/c/cells/9) gdzie członkowie społeczności i członkowie zespołu Aspose pomagają użytkownikom.
