...
```
Podsumowanie: 
- R[-10]C[0] odnosi się do komórki znajdującej się dziesięć wierszy nad bieżącą w kolumnie A.
...
## Wniosek
I masz to! Właśnie przeszedłeś przez zawiły świat formuł R1C1, używając Aspose.Cells dla .NET. Teraz możesz dynamicznie odwoływać się do komórek i wykonywać obliczenia bez uciążliwego zadania śledzenia statycznych adresów komórek. 
