...
Pierwszą rzeczą, którą musimy zrobić, jest odczytanie danych JSON z pliku. Załóżmy, że masz już plik JSON (nazwijmy go `SampleJson.json`) zapisane w katalogu na Twoim systemie.
