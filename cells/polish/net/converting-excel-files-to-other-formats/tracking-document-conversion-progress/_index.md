...
Teraz skonfigurujmy opcje zapisywania PDF. To tutaj zaczyna się magia śledzenia postępu. Utworzysz wystąpienie`PdfSaveOptions` i przypisz do niego wywołanie zwrotne.
```csharp
