...
Zanim zaczniesz pracować z skoroszytem, musisz ustalić, gdzie będą zapisywane Twoje pliki. Zawsze dobrym pomysłem jest utworzenie katalogu dokumentów, jeśli jeszcze go nie masz.
```csharp
...
```
Ten kod tworzy zakres zaczynający się od pierwszego wiersza (indeks 0) i pierwszej kolumny (indeks 0) i rozciągający się na jeden wiersz i trzy kolumny (od A1 do C1).
...
### Gdzie mogę uzyskać pomoc w rozwiązywaniu problemów z Aspose.Cells?
