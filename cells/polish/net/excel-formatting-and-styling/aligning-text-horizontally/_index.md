...
Teraz, gdy wszystko jest gotowe, przejdźmy krok po kroku przez proces wyrównywania tekstu poziomo w komórkach programu Excel. Utworzymy prosty plik programu Excel, dodamy tekst do komórki i dostosujemy wyrównanie.
...
```
 Tutaj wstawiamy frazę`"Visit Aspose!"` do komórki A1. Możesz zastąpić go dowolnym tekstem według własnego wyboru.
