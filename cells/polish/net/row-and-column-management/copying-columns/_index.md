...
### Czy mogę skopiować wiele kolumn jednocześnie używając Aspose.Cells?  
 Tak, ale wymaga to indywidualnego przejścia przez każdą kolumnę, ponieważ`CopyColumn`działa na jednej kolumnie na raz. 
...
Tak, dzięki ładowaniu oddzielnych skoroszytów można łatwo kopiować dane z arkusza jednego skoroszytu do drugiego.
