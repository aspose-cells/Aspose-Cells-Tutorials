...
- Plik Excela: Przygotuj plik Excela, z którym będziesz pracować (w tym przewodniku będziemy się do niego odwoływać jako do pliku Excela).`book1.xls`).
## Importuj pakiety
...
- Pierwszy parametr (1) jest indeksem kolumny początkowej.
