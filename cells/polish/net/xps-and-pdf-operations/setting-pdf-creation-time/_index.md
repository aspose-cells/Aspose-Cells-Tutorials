...
Najpierw musisz określić katalog, w którym przechowywane są Twoje dokumenty. To jest miejsce, w którym znajduje się Twój plik Excel i gdzie zostanie zapisany wyjściowy plik PDF.
```csharp
