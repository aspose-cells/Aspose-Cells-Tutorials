...
Ten wiersz pobiera pierwszy arkusz roboczy ze zbioru. Indeksowanie w programowaniu często zaczyna się od zera, dlatego używamy `[0]`. Potraktuj to jako wybór pierwszego rozdziału w swojej książce, gotowego do modyfikacji.
