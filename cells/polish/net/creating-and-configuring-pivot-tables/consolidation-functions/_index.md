...
Najpierw musimy ustalić ścieżkę dla naszych dokumentów. Dotyczy to folderu, w którym przechowywane są pliki Excel.
```csharp
...
Teraz czas na zastosowanie funkcji konsolidacji! Obliczmy średnią dla pierwszego pola danych i policzmy różne wpisy dla drugiego pola danych.
```csharp
