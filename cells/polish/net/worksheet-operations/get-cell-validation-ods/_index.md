...
```
-  Arkusze kalkulacyjne są indeksowane od zera.`Worksheets[0]` uzyskuje dostęp do pierwszego arkusza, w którym zazwyczaj znajdują się Twoje dane.
...
```
-  Ten`GetValidation()`Metoda zwraca obiekt walidacji powiązany z komórką. Jeśli nie jest`null`, oznacza to, że obowiązują pewne reguły walidacji.
