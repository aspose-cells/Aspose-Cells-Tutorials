...
4. Plik Excel: Przygotuj plik Excel z kilkoma komentarzami wątkowymi. W tym przykładzie użyjemy pliku o nazwie `ThreadedCommentsSample.xlsx`.
...
Po pobraniu komentarzy wątkowych możemy je teraz przejrzeć i wyświetlić szczegóły, włącznie z czasem utworzenia:
```csharp
