...
Do końca tego artykułu będziesz w stanie bezproblemowo wyodrębnić i odczytać szczegóły efektu świecenia kształtów z plików Excel. Więc zakasajmy rękawy i zaczynajmy!
## Wymagania wstępne
...
```
 Tutaj pobieramy pierwszy kształt z arkusza roboczego`Shapes` kolekcja. Jeśli twój arkusz zawiera więcej kształtów i chcesz uzyskać dostęp do innego, dostosuj indeks odpowiednio.
## Krok 5: Odczytaj właściwości efektu świecenia
Po uzyskaniu dostępu do kształtu nadszedł czas, aby zagłębić się w jego właściwości świecenia. Może to dać nam mnóstwo informacji, takich jak kolor, przezroczystość i inne.
```csharp
