...
```
-  Zastępować`"Your Document Directory"` rzeczywistą ścieżką, w której chcesz zapisać plik. Na przykład możesz użyć`C:\\Documents\\AsposeOutput\\`.
...
```
- Możesz dostosować swoje imiona, jeśli to konieczne. Możesz przetestować swoją własną listę imion lub utworzyć bardziej zróżnicowany zestaw.
...
// Teraz kolumna A będzie zawierać imię, a kolumna B nazwisko.
...
```
- Upewnij się, że nadasz plikowi sensowną nazwę. W tym przypadku zapisujemy go jako`outputTextToColumns.xlsx`, ale możesz zmienić jej nazwę na dowolną inną, którą uznasz za stosowną.
## Wniosek
...
Oczywiście! Dzięki prostym przykładom i obszernej dokumentacji nawet początkujący mogą szybko to zrozumieć.
