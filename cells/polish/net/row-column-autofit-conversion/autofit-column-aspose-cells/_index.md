...
Mając gotowy skoroszyt, musimy uzyskać dostęp do konkretnego arkusza, w którym chcemy automatycznie dopasować kolumnę. W tym przypadku będziemy pracować z pierwszym arkuszem.
```csharp
