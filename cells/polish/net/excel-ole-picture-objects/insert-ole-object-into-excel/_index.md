---
title: Wstawianie obiektu OLE do programu Excel
linktitle: Wstawianie obiektu OLE do programu Excel
...
# Wstawianie obiektu OLE do programu Excel
...
fs.Close();
```
Przygotowuje to plik Excela do osadzenia w nim obiektu OLE.
