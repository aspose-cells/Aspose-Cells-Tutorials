...
```
 Tutaj,`UpperDeltaX` I`UpperDeltaY` dostosuj położenie obrazu względem wymiarów komórki. Możesz zmienić te wartości, aby uzyskać odpowiedni obraz.
...
## Wniosek
masz to! Właśnie nauczyłeś się, jak proporcjonalnie ustawiać obrazy w programie Excel za pomocą Aspose.Cells dla .NET. Nie chodzi tylko o wstawianie obrazów; chodzi o to, aby wyglądały idealnie w arkuszach kalkulacyjnych. Pamiętaj tylko: dobrze umieszczony obraz może znacznie podnieść poziom prezentacji danych.
