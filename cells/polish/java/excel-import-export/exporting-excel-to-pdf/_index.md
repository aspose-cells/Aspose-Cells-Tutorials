...
public class ExcelToPdfConverter {
    ...
    public static void main(String[] args) {
        try {
            ...
            // W razie potrzeby można tutaj dodać dodatkowy kod, aby manipulować danymi w programie Excel.
