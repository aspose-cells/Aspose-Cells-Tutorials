...
Aby pracować z tabelą przestawną, musisz uzyskać do niej dostęp w arkuszu kalkulacyjnym. Załóżmy, że tabela przestawna ma nazwę „PivotTable1”.
...
### Czy Aspose.Cells for Java nadaje się do dużych zbiorów danych?
   Tak, Aspose.Cells for Java jest przeznaczony do wydajnej obsługi dużych plików Excela i zestawów danych.
