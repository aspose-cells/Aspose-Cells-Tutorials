...
Bạn có thể thêm tham chiếu bằng NuGet Package Manager hoặc bằng cách thêm trực tiếp Aspose.Cells DLL vào dự án của bạn. Để thực hiện việc này:
...
```
 Giải thích: Các bộ cắt được lưu trữ dưới dạng một bộ sưu tập trong bảng tính. Bằng cách chỉ định`[0]`, chúng ta đang lấy máy cắt đầu tiên có sẵn. Giống như nhìn vào mảnh ghép đầu tiên trong số nhiều mảnh ghép - hãy làm việc với mảnh ghép này!
