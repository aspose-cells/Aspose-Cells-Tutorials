...
Sau khi sao chép các phạm vi cần thiết, bạn sẽ muốn lưu sổ làm việc đã sửa đổi để giữ nguyên các thay đổi của mình. Thực hiện như sau:
```csharp
...
Có, Aspose.Cells cho phép bạn sao chép không chỉ giá trị mà còn cả định dạng và công thức giữa các phạm vi.
