...
```
Đoạn mã này thêm một thuộc tính mới với khóa là `"MK32"` và đặt giá trị của nó thành ngày và giờ hiện tại được định dạng theo một cách cụ thể. Ở đây, `IsNillable` được thiết lập để `true`, nghĩa là không sao nếu trường này để trống. Hãy nghĩ về việc tạo một trường tùy chọn trong một cuộc khảo sát.
