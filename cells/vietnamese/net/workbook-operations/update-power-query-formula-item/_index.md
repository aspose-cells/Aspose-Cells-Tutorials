...
3. Một tệp Excel sẵn sàng để sửa đổi: Đảm bảo bạn có tệp Excel chứa Power Query mà bạn muốn cập nhật. Bạn cần có một sổ làm việc mẫu như `SamplePowerQueryFormula.xlsx` theo ý bạn.
## Nhập gói
...
```
Trong bước này, bạn chỉ định đường dẫn thư mục. Thay thế `"Your Document Directory"` với đường dẫn thực tế nơi lưu các tệp Excel của bạn. Điều này cho chương trình biết nơi tìm tệp nguồn của bạn và nơi lưu tệp đã cập nhật.
## Bước 2: Tải Workbook
...
Aspose.Cells cung cấp bản dùng thử miễn phí, nhưng để sử dụng liên tục, cần có giấy phép. Bạn có thể xin giấy phép tạm thời [đây](https://purchase.aspose.com/temporary-license/).
