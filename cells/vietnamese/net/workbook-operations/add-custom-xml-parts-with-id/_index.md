---
title: Thêm các phần XML tùy chỉnh có ID vào sổ làm việc
linktitle: Thêm các phần XML tùy chỉnh có ID vào sổ làm việc
...
using System.Text;
```
Dòng này cho phép bạn truy cập tất cả các chức năng được cung cấp bởi Aspose.Cells.
