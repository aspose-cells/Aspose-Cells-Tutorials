...
```
Với luồng tập tin tại chỗ, bây giờ chúng ta tạo một phiên bản của `Workbook` lớp, đại diện cho toàn bộ tệp Excel. Bước này rất quan trọng vì nó cho chúng ta khả năng thao tác dữ liệu trong bảng tính của mình.
...
```
Dòng ma thuật này yêu cầu Aspose.Cells tự động điều chỉnh chiều cao của hàng thứ hai (hãy nhớ rằng, nó được lập chỉ mục bằng 0) để phù hợp với nội dung của nó. Hãy tưởng tượng bạn có một bộ đồ may đo – bước này đảm bảo các hàng của bạn hoàn toàn phù hợp với nội dung của chúng!
