...
5. Tệp mẫu: Chuẩn bị một tệp Excel mẫu bao gồm tài nguyên bên ngoài, chẳng hạn như hình ảnh được liên kết. Tệp này sẽ giúp chứng minh các chức năng mà chúng ta thảo luận.
...
Sau khi tải sổ làm việc, chúng ta có thể dễ dàng truy cập vào trang tính mong muốn. Hãy lấy trang đầu tiên.
```csharp
