...
Đã đến lúc tạo một phạm vi ô mà chúng ta muốn định dạng. Trong bước này, chúng ta sẽ xác định số hàng và cột mà phạm vi của chúng ta sẽ bao phủ.
...
Giải thích: Dòng này in ra thông báo đến bảng điều khiển cho biết chương trình của chúng ta đã chạy thành công. Một chút vui mừng khi kết thúc cuộc phiêu lưu viết mã của chúng ta!
