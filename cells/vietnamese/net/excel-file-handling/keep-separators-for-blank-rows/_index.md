...
Trước tiên, hãy thiết lập đường dẫn đến thư mục tài liệu của bạn. Đây là nơi chứa tệp Excel gốc và các tệp đầu ra của bạn. Sau đây là cách bạn có thể định nghĩa nó:
```csharp
