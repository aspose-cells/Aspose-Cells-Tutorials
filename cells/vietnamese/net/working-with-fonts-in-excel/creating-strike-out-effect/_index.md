...
```
Tại đây, bạn đang lấy bảng tính mới được tạo bằng cách sử dụng chỉ mục của nó (`i`). Thao tác này cho phép bạn thao tác trên bảng tính.
...
cell.SetStyle(style);
```
Các `SetStyle` phương pháp này cập nhật ô theo kiểu mới, hiện bao gồm định dạng gạch bỏ.
