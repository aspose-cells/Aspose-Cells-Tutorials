...
```
Thao tác này sẽ lấy lại kiểu hiện tại của tế bào, cho phép chúng ta điều chỉnh các đặc tính thẩm mỹ của tế bào.
...
Bây giờ chúng ta đã có phông chữ màu xanh, hãy áp dụng lại kiểu đó cho ô của chúng ta.
```csharp
// Áp dụng kiểu cho ô
cell.SetStyle(style);
```
