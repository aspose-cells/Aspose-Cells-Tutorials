...
Để bắt đầu, chúng ta cần tạo một sổ làm việc mới. Hãy nghĩ về sổ làm việc như một bức tranh của bạn, sẵn sàng chứa nhiều trang tính có dữ liệu quan trọng. Sau đây là cách chúng ta thực hiện:
```csharp
