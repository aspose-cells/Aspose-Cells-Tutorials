...
"linktitle": "Lấy kích thước trang của trang tính"
"second_title": "API xử lý Excel Aspose.Cells .NET"
"title": "Lấy kích thước trang của trang tính"
...
# Lấy kích thước trang của trang tính
...
Bạn có thể thay đổi hướng bằng cách sử dụng `PageSetup.Orientation` thuộc tính, đặt nó thành `PageOrientationType.Phoặctrait` or `PageOrientationType.Landscape`.
