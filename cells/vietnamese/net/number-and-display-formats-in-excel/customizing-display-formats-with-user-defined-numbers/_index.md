...
## Bước 5: Định dạng một ô theo đơn vị tiền tệ
Hãy thêm một giá trị khác, ví dụ như vào ô `A3`và định dạng để hiển thị dưới dạng tiền tệ. Để làm cho mọi thứ thú vị hơn, chúng ta sẽ sử dụng định dạng hiển thị giá trị dương dưới dạng tiền tệ tính bằng pound và giá trị âm tính bằng đô la.
```csharp
