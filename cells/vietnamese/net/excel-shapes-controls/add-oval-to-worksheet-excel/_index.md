...
Ở đây, chúng tôi sử dụng `Shapes.AddOval()` phương pháp tạo hình bầu dục trên bảng tính ở một hàng và cột cụ thể.
```csharp
// Thêm hình bầu dục.
...
Sau khi hình bầu dục được tạo, chúng ta có thể thiết lập vị trí, độ dày đường nét và kiểu nét đứt của nó. `Placement` Thuộc tính này xác định cách hình bầu dục hoạt động khi bạn thay đổi kích thước hoặc di chuyển các ô trong bảng tính.
