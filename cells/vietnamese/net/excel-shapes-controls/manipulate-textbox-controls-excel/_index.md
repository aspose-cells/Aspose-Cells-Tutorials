...
Bây giờ chúng ta đã thiết lập xong mọi thứ, hãy chia nhỏ quá trình thao tác hộp văn bản thành các bước dễ thực hiện.
...
```
Điều này sẽ chụp văn bản từ hộp văn bản đầu tiên vào `text0` chuỗi. Bây giờ bạn có thể hiển thị, thao tác hoặc xử lý nó trong ứng dụng của mình.
...
Nếu chỉ mục của hộp văn bản nằm ngoài phạm vi, một `IndexOutOfRangeException` sẽ được ném ra.
...
Có, bạn sẽ cần phải mua giấy phép, nhưng Aspose cũng cung cấp [dùng thử miễn phí](https://releases.aspose.com/).
