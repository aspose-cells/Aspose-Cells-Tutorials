...
```
Kiểm tra đơn giản này giúp chương trình của bạn tránh gây ra những lỗi không cần thiết sau này.
...
Khi dữ liệu đã sẵn sàng, chúng ta có thể chèn đối tượng OLE vào bảng tính.
```csharp
