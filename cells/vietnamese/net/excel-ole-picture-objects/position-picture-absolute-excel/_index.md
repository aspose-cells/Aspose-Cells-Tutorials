...
4. Tệp hình ảnh: Lưu tệp hình ảnh (ví dụ: “logo.jpg”) trong thư mục tài liệu được chỉ định mà bạn dự định chèn vào bảng tính Excel của mình.
...
### Tôi có thể tìm thêm ví dụ và tài liệu ở đâu?
 Các[Tài liệu Aspose.Cells](https://reference.aspose.com/cells/net/) chứa nhiều tài nguyên mở rộng, bao gồm các ví dụ mã và các tính năng chi tiết hơn.
{{< /blocks/products/pf/tutorial-page-section >}}
