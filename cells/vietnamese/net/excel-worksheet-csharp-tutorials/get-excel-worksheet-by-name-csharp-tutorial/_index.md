...
Trước khi đi sâu vào phần hấp dẫn, hãy đảm bảo bạn đã sẵn sàng để thành công. Sau đây là những gì bạn cần:
...
Trước tiên, chúng ta cần cho chương trình biết tệp Excel nằm ở đâu. Điều này bao gồm việc chỉ định đường dẫn đến thư mục tài liệu của bạn và thêm tên tệp.
...
Có! Bạn có thể truy cập nhiều trang tính bằng cách sử dụng tên của chúng với `workbook.Worksheets["SheetName"]` phương pháp.
