...
```
 Lệnh này lưu sổ làm việc đã chỉnh sửa dưới dạng`output.xls` trong thư mục đã chỉ định. Và voilà! Bạn đã xóa thành công ngăn chia tách khỏi bảng tính của mình.
## Phần kết luận
