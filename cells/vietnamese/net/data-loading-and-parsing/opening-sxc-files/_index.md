...
5. Sau khi dự án tải xong, bạn sẽ thấy một mặc định `.cs` tệp nơi chúng ta có thể thêm mã của mình.
...
Aspose.Cells là sản phẩm cao cấp và mặc dù có bản dùng thử miễn phí, nhưng cần có giấy phép để sử dụng liên tục. Bạn có thể nhận được giấy phép tạm thời [đây](https://purchase.aspose.com/temporary-license/).
