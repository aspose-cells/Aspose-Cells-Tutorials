...
Tiếp theo, chúng ta cần tạo một phiên bản của `Workbook` class và tải tệp Excel. Đây là nơi Aspose.Cells tỏa sáng—cho phép chúng ta thao tác sổ làm việc Excel dễ dàng.
