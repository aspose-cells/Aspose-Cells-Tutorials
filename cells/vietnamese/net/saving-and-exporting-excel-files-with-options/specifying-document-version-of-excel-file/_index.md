...
Bạn có thể khám phá Aspose.Cells bằng [dùng thử miễn phí](https://releases.aspose.com/) hoặc nộp đơn xin một [giấy phép tạm thời](https://purchase.aspose.com/temporary-license/) để thử nghiệm mở rộng.
...
Bạn có thể truy cập cộng đồng và hỗ trợ thông qua [Diễn đàn hỗ trợ Aspose.Cells](https://forum.aspose.com/c/cells/9).
