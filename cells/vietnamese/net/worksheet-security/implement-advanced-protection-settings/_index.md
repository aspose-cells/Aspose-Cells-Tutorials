...
3. Hiểu biết cơ bản về C#: Trong khi chúng tôi sẽ giải thích từng bước, hiểu biết cơ bản về lập trình C# sẽ giúp bạn hiểu được bối cảnh.
4.  Tệp Excel mẫu: Chuẩn bị một tệp Excel mà bạn muốn làm việc. Đối với ví dụ của chúng tôi, chúng tôi sẽ sử dụng`book1.xls`.
...
```
 Ở đây, chúng ta đang khởi tạo`Workbook` và vượt qua chúng tôi`FileStream` đối tượng. Bước này là nơi chúng ta tải tài liệu Excel vào bộ nhớ.
