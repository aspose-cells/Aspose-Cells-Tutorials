...
description: Tìm hiểu cách ẩn nhiều hàng và cột trong Excel một cách dễ dàng bằng Aspose.Cells for .NET. Thực hiện theo hướng dẫn từng bước này để thao tác Excel liền mạch.
weight: 16
...
### Làm thế nào tôi có thể dùng thử Aspose.Cells miễn phí?  
 Bạn có thể tải xuống một[dùng thử miễn phí](https://releases.aspose.com/) hoặc nộp đơn xin[giấy phép tạm thời](https://purchase.aspose.com/temporary-license/) dành cho Aspose.Cells.
{{< /blocks/products/pf/tutorial-page-section >}}
