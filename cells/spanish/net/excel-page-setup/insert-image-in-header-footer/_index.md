---
title: Insertar imagen en encabezado y pie de página
linktitle: Insertar imagen en encabezado y pie de página
second_title: Referencia de API de Aspose.Cells para .NET
description: Aprenda a insertar imágenes en encabezados y pies de página usando Aspose.Cells para .NET con esta completa guía paso a paso.
weight: 60
...
- La segunda línea agrega el nombre de la hoja en la sección derecha del encabezado, utilizando el marcador de posición (`&A`).
...
### ¿Aspose.Cells es gratuito?
 Aspose.Cells ofrece una versión de prueba gratuita, pero hay una versión con licencia disponible para acceder a todas las funciones y obtener funciones adicionales. Puede obtener una[Licencia temporal aquí](https://purchase.aspose.com/temporary-license/).
