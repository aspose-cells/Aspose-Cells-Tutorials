...
```
Langkah ini menginisialisasi `Workbook` objek dengan konten berkas yang ada.
...
```
Itu `save` Metode ini memungkinkan Anda menentukan jalur dan nama file keluaran.
...
**Langkah Berikutnya:**
- Jelajahi fitur yang lebih canggih di Aspose.Cells.
