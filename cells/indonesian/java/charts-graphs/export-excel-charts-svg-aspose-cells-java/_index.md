...
1. **Uji Coba Gratis:** Unduh dan terapkan lisensi uji coba gratis dari [Situs web Aspose](https://releases.aspose.com/cells/java/).
2. **Lisensi Sementara:** Dapatkan lisensi sementara untuk pengujian mendalam terhadap fitur-fitur lanjutan.
3. **Pembelian:** Untuk proyek komersial, pembelian lisensi memastikan akses tanpa gangguan ke Aspose.Cells.
...
Muat file Excel sumber Anda ke dalam `Workbook` obyek.
```java
...
- Pastikan jalur di `dataDir` Dan `outDir` benar dan dapat diakses.
...
4. **Apakah Aspose.Cells gratis untuk digunakan?**
   - Lisensi uji coba tersedia, tetapi penggunaan komersial memerlukan pembelian lisensi penuh.
...
- **Uji Coba Gratis dan Lisensi Sementara:** [Uji Coba Aspose](https://releases.aspose.com/cells/java/)
