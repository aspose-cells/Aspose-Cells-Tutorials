...
- **Uji Coba Gratis**: Unduh dan mulai uji coba untuk akses segera.
- **Lisensi Sementara**:Ajukan permohonan jika Anda menginginkan kemampuan evaluasi yang lebih luas.
...
Worksheet worksheet = worksheets.get(0); // Mengakses lembar kerja pertama
```
**Penjelasan:** 
Itu `WorksheetCollection` memungkinkan Anda mengambil lembar tertentu dalam buku kerja Anda. Dalam kasus ini, kita memilih lembar pertama.
...
```
**Penjelasan:** 
Itu `unprotect` metode menghapus proteksi dari lembar kerja. Argumen yang dimasukkan di sini harus sesuai dengan kata sandi proteksi asli.
...
2. **Pemrosesan Batch**: Mengelola sejumlah besar file yang dilindungi secara efisien tanpa campur tangan manual.
