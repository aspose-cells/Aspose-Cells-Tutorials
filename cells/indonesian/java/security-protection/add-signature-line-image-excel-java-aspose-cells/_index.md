...
- **Lisensi Sementara:** Dapatkan melalui [Beli Aspose](https://purchase.aspose.com/temporary-license/) untuk tujuan evaluasi.
- **Beli Lisensi:** Mengunjungi [Beli Sel Aspose](https://purchase.aspose.com/buy) untuk mendapatkan lisensi permanen.
...
```
*Penjelasan:* Itu `save` metode ini menulis buku kerja Anda ke disk, sehingga memungkinkan Anda untuk menyimpan dan kemudian memodifikasinya.
...
```
*Penjelasan:* Lembar kerja diindeks mulai dari nol, jadi `get(0)` mengakses lembar kerja pertama.
...
```
*Penjelasan:* Itu `add` metode menyisipkan gambar pada indeks baris dan kolom yang ditentukan. Di sini, gambar ditempatkan di sudut kiri atas.
...
```
*Penjelasan:* Mirip dengan bagian sebelumnya, kami menambahkan gambar dan mengambilnya untuk manipulasi lebih lanjut.
...
workbook.save(dataDir + "CSignatureLine_out.xlsx");
```
*Penjelasan:* Itu `SignatureLine` objek dikonfigurasikan dengan rincian yang diperlukan dan ditautkan ke gambar, menandainya untuk tanda tangan digital.
...
5. **Di mana saya dapat menemukan dokumentasi API terperinci untuk Aspose.Cells?**
   - Mengunjungi [Dokumentasi Aspose](https://reference.aspose.com/cells/java/) untuk panduan dan referensi yang lengkap.

## Sumber daya
- **Dokumentasi:** Jelajahi panduan terperinci di [Referensi Aspose](https://reference.aspose.com/cells/java/).
- **Unduh Perpustakaan:** Akses versi terbaru dari [Halaman Rilis](https://releases.aspose.com/cells/java/).
- **Beli Lisensi:** Mengunjungi [Beli Sel Aspose](https://purchase.aspose.com/buy) untuk mendapatkan lisensi permanen Anda.
