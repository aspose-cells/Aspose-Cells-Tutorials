...
Anda dapat melindungi seluruh lembar kerja Excel menggunakan Aspose.Cells untuk Java dengan memanggil `protect` metode pada objek lembar kerja dengan `ProtectionType.ALL` paraméter.
