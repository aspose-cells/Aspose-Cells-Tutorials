...
- **Uji Coba Gratis**: Akses Aspose.Cells dengan lisensi uji coba terbatas untuk menjelajahi kemampuannya.
- **Lisensi Sementara**: Dapatkan lisensi sementara untuk evaluasi lanjutan tanpa batasan.
- **Pembelian**:Untuk penggunaan komersial, beli lisensi penuh dari [Situs web Aspose](https://purchase.aspose.com/buy).
...
```
**Penjelasan**: 
Itu `Workbook` class mewakili keseluruhan file Excel. Dengan memberikan path file, Anda membuat instance dari class ini untuk digunakan pada dokumen Anda.
...
```
**Penjelasan**: 
Itu `ThreeDFormat` memungkinkan Anda untuk mengatur properti seperti lebar kontur dan jenis bevel. Metode seperti `setContourWidth` menyesuaikan atribut visual tertentu dari bentuk tersebut.
...
```
**Penjelasan**: 
Itu `save` metode menulis semua perubahan ke file baru di direktori yang ditentukan.
...
2. **Visualisasi Data**: Gunakan bentuk 3D untuk secara efektif merepresentasikan struktur data yang kompleks.
...
**Ajakan Bertindak**:Coba terapkan solusi ini dalam proyek Anda hari ini dan lihat bagaimana solusi ini meningkatkan kemampuan presentasi data Anda!
