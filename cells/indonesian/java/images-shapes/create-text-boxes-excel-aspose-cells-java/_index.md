...
- **Lisensi Uji Coba Gratis:** Mengunjungi [Halaman Uji Coba Gratis Aspose](https://releases.aspose.com/cells/java/) untuk akses sementara.
- **Opsi Pembelian:** Kunjungi [Aspose Pembelian](https://purchase.aspose.com/buy) untuk membeli lisensi penuh.
...
Menggunakan `addShape` metode, menentukan tipe sebagai `TEXT_BOX`, beserta dimensi dan posisi:
```java
...
2. **Laporan Keuangan:** Menyoroti titik data utama menggunakan penyelarasan yang berbeda.
...
- Kelola memori dengan membuang objek yang tidak digunakan menggunakan `dispose()` metode jika berlaku.
...
- **Unduh:** [Rilisan Terbaru Aspose.Cells](https://releases.aspose.com/cells/java/)
...
- **Dukungan Komunitas:** [Forum Dukungan Aspose](https://forum.aspose.com/c/cells/9)
