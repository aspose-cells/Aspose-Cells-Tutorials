...
-  Pustaka Aspose.Cells: Anda harus menginstal pustaka Aspose.Cells. Jika Anda belum melakukannya, Anda dapat menemukan informasi lebih lanjut[Di Sini](https://releases.aspose.com/cells/net/).
...
Setelah memasukkan rumus, saatnya menjalankan perhitungan. Hal ini dapat dilakukan dengan mudah dengan memanggil:
```csharp
...
### Bisakah saya menggunakan Aspose.Cells secara gratis?
 Ya! Anda dapat mencobanya dengan uji coba gratis yang tersedia untuk diunduh[Di Sini](https://releases.aspose.com/).
...
### Bagaimana cara memecahkan masalah dengan Aspose.Cells?
 Anda bisa mendapatkan dukungan dari forum Aspose[Di Sini](https://forum.aspose.com/c/cells/9)untuk pemecahan masalah atau pertanyaan spesifik apa pun.
### Di mana saya dapat menemukan dokumentasi terperinci?
 Dokumentasi terperinci tersedia[Di Sini](https://reference.aspose.com/cells/net/) untuk semua fitur dan fungsi.
{{< /blocks/products/pf/tutorial-page-section >}}
