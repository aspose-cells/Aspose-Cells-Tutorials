...
2. Aspose.Cells untuk .NET: Anda perlu mengunduh dan menginstal Aspose.Cells. Jika Anda belum memilikinya, Anda bisa mendapatkannya [itt](https://releases.aspose.com/cells/net/).
...
```
A `dataDir` variabel akan menyimpan jalur tempat Anda menyimpan berkas Excel akhir. Pastikan Anda mengganti "DIREKTORI DOKUMEN ANDA" dengan jalur sebenarnya di sistem Anda.

## Langkah 2: Buat Buku Kerja Baru dan Isi dengan Data

Selanjutnya, mari kita buat buku kerja pertama kita dan tambahkan beberapa contoh data ke dalamnya. Berikut caranya:
...
ws1.Copy(ws0);
```
A `Copy` metode mengambil semua konten dari lembar kerja sumber (`ws0`) dan menduplikasinya ke lembar kerja tujuan (`ws1`). Sederhana sekali, bukan?
...
Ya, Aspose.Cells menawarkan uji coba gratis, yang dapat Anda akses [itt](https://releases.aspose.com/).

### Hogyan szerezhetek ideiglenes licencet az Aspose.Cells-hez?  
Anda dapat meminta lisensi sementara dengan mengunjungi [ezt a linket](https://purchase.aspose.com/temporary-license/).
