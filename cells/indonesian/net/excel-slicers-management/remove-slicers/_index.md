...
3.  Aspose.Cells untuk .NET: Anda harus memiliki pustaka ini. Jika Anda belum memilikinya, Anda dapat[unduh disini](https://releases.aspose.com/cells/net/).
...
### Butuh Bantuan Lebih Lanjut?
 Jika Anda memiliki pertanyaan atau memerlukan dukungan, jangan ragu untuk memeriksa[Forum Aspose](https://forum.aspose.com/c/cells/9).
## Paket Impor
...
```
 Cukup ganti`"Your Document Directory"`dengan jalur sebenarnya di komputer Anda tempat file Excel Anda berada.
...
### Apakah Aspose.Cells gratis untuk digunakan?
 Aspose.Cells menawarkan[uji coba gratis](https://releases.aspose.com/) versi, tetapi Anda memerlukan lisensi berbayar untuk fungsionalitas penuh.
