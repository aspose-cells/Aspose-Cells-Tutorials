...
2. Pustaka Aspose.Cells untuk .NET: Anda perlu memiliki pustaka Aspose.Cells. Jika Anda belum memilikinya, Anda dapat mengunduhnya dari [itt](https://releases.aspose.com/cells/net/).
...
Penjelasan: `&D` és `&T` kode akan secara otomatis mengganti dirinya sendiri dengan tanggal dan waktu saat ini. Kami juga menentukan bahwa font untuk header ini harus "Times New Roman" dan tebal.
...
Sekarang header kita sudah terlihat menarik, mari kita alihkan perhatian ke footer. Kita akan mulai dengan footer kiri:
...
Anda dapat memeriksa dokumentasi terperinci di [Aspose.Cells dokumentáció](https://reference.aspose.com/cells/net/).
