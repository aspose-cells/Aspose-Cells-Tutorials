...
2. Pustaka Aspose.Cells untuk .NET: Anda perlu memiliki pustaka Aspose.Cells. Jika Anda belum memilikinya, Anda dapat mengunduhnya dari [Aspose.Cells letöltési oldal](https://releases.aspose.com/cells/net/).
...
4. Kunci Lisensi (Opsional): Meskipun Anda dapat menggunakan versi uji coba, memiliki lisensi sementara atau penuh dapat membantu membuka semua fitur. Anda dapat mempelajari lebih lanjut tentang lisensi [itt](https://purchase.aspose.com/temporary-license/).
...
Új példány létrehozása `Workbook` objek sebagai berikut:

```csharp
Workbook workbook = new Workbook();
```

Dengan baris kode ini, Anda baru saja membuat buku kerja kosong yang siap digunakan!
...
Csere `"SetMargins_out.xls"` dengan nama berkas keluaran yang Anda inginkan. 
...
Anda dapat menjelajahi dokumentasi Aspose.Cells [itt](https://reference.aspose.com/cells/net/).
