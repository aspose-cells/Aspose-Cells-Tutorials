...
3. Pustaka Aspose.Cells untuk .NET: Anda perlu mendapatkan Aspose.Cells. Anda dapat [töltsd le itt](https://releases.aspose.com/cells/net/).
...
Csere `"YOUR DOCUMENT DIRECTORY"` dengan jalur sebenarnya pada sistem Anda tempat Anda ingin menyimpan berkas tersebut. Misalnya, bisa jadi seperti ini `C:\Documents\`.
...
Baris ini membuat buku kerja baru di memori. Jika Anda bekerja dengan file yang sudah ada, Anda dapat meneruskan jalur file ke `Workbook` konstruktőr.
...
Baris ini mengatur ukuran kertas untuk lembar kerja yang ditentukan ke A4. Anda dapat dengan mudah mengganti `PaperA4` dengan ukuran kertas lain yang tersedia di `PaperSizeType` pencacahan, seperti `PaperLetter` vagy `PaperA3`.
...
Aspose.Cells adalah pustaka komersial; namun, pustaka ini menawarkan uji coba gratis. Anda dapat meminta uji coba gratis. [ideiglenes engedély](https://purchase.aspose.com/temporary-license/) untuk mengevaluasi fitur lengkapnya.
...
Anda dapat menemukan informasi lebih lanjut di [dokumentáció](https://reference.aspose.com/cells/net/) vagy látogassa meg a [támogató fórum](https://forum.aspose.com/c/cells/9).
