...
# Penyelarasan dan Pemformatan Data Excel
...
2. Terapkan Penyelarasan yang Diinginkan:
   Használd a `.Style` properti untuk menerapkan pengaturan perataan horizontal atau vertikal. Aspose.Cells memberi Anda opsi seperti `TextAlignmentType.Center`, `TextAlignmentType.Left`, atau `TextAlignmentType.Right` untuk penyelarasan horizontal dan pilihan serupa untuk penyelarasan vertikal.
