...
2. Aspose.Cells untuk .NET - Anda perlu memiliki pustaka Aspose.Cells. Jika Anda belum menginstalnya, Anda dapat mengunduhnya dari [Aspose oldal](https://releases.aspose.com/cells/net/).
### Alapismeretek
...
```
Dengan baris kode ini, Anda sekarang memiliki buku kerja kosong yang siap beraksi.
...
Untuk dukungan, Anda dapat mengunjungi Aspose.Cells [támogató fórum](https://forum.aspose.com/c/cells/9).
