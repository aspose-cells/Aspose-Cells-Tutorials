...
2. Pustaka Aspose.Cells: Anda memerlukan pustaka Aspose.Cells for .NET. Anda dapat mengunduhnya dari [halaman](https://releases.aspose.com/cells/net/), atau Anda dapat memilih [ingyenes próba](https://releases.aspose.com/).
...
```
Itt használjuk a `PutValue` metode untuk menyetel teks menjadi "Hello Aspose!". Selalu menyenangkan melihat teks Anda muncul di Excel!
...
```
Baris ini secara efisien menyimpan semuanya ke dalam direktori yang ditentukan, termasuk formatnya!
## Következtetés
...
Sumber daya dan dokumentasi tambahan dapat ditemukan [itt](https://reference.aspose.com/cells/net/).
