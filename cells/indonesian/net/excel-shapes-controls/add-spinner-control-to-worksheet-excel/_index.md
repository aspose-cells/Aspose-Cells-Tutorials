...
1. Aspose.Cells untuk .NET: Pastikan Anda memiliki pustaka Aspose.Cells. Jika Anda belum menginstalnya, Anda dapat mengunduh versi terbaru dari [letöltési link](https://releases.aspose.com/cells/net/).
...
```
A `Workbook` class merupakan file Excel. Dengan membuatnya, kita membuat buku kerja baru yang siap untuk dimodifikasi.
...
Támogatásért látogassa meg a [Aspose fórum](https://forum.aspose.com/c/cells/9) tempat Anda dapat mengajukan pertanyaan dan mendapatkan jawaban.
