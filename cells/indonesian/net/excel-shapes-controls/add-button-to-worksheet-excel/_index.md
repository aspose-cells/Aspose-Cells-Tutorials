...
- Lisensi: Anda memerlukan lisensi yang valid. Jika Anda belum memilikinya, Anda bisa mendapatkannya [ingyenes próba](https://releases.aspose.com/) atau melamar [ideiglenes engedély](https://purchase.aspose.com/temporary-license/).
...
- Referensi Lembar Kerja: `Worksheets[0]` perintah mengambil lembar kerja pertama dalam buku kerja, yang akan kita modifikasi.
...
Mari berikan tombol tersebut sedikit gaya dengan menyesuaikan properti font.
```csharp
// Tetapkan nama font.
...
Használd a `PlacementType.Move` properti untuk memungkinkan tombol diubah ukurannya sesuai dengan sel.
