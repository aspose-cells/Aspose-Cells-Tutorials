...
Setelah kita melakukan penggantian, saatnya menyimpan buku kerja yang dimodifikasi ke dalam format yang diinginkan. Berikut cara mengonversinya ke PDF.
```csharp
...
Anda dapat menemukan dukungan dan mengajukan pertanyaan di [Aspose fórum](https://forum.aspose.com/c/cells/9).
