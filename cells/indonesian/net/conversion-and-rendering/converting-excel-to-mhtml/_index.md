...
2. Pustaka Aspose.Cells: Anda akan memerlukan pustaka Aspose.Cells untuk .NET. Anda dapat mengunduhnya dengan mudah dari [Aspose weboldal](https://releases.aspose.com/cells/net/).
...
Csere `"Your Document Directory"` dengan jalur sebenarnya ke folder yang berisi file Excel Anda.
...
```csharp
// Buat buku kerja dan buka file XLSX templat
...
Ya! Anda dapat melakukan pengulangan melalui serangkaian file dan menerapkan logika konversi yang sama pada setiap file.
...
Anda dapat menemukan utas dukungan di [Aspose fórum](https://forum.aspose.com/c/cells/9), yang merupakan sumber yang bagus untuk pemecahan masalah.
