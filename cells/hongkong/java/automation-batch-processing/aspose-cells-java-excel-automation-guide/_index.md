---
date: '2026-03-04'
description: 學習如何使用 Aspose.Cells for Java 建立 Excel 命名範圍、套用 Excel 邊框，並將活頁簿儲存為 xls，以實現自動化
  Excel 報表。
keywords:
- Aspose.Cells Java
- Excel automation Java
- Java workbook creation
title: 使用 Aspose Cells Java 建立 Excel 命名範圍
...
# 使用 Aspose Cells Java 建立命名範圍 Excel
