...
### [複製樞紐分析表並使用 Aspose.Cells 將 Excel 匯出為 PPTX](./copy-pivot-table-and-export-excel-to-pptx-with-aspose-cells/)
說明如何使用 Aspose.Cells 複製樞紐分析表並將 Excel 檔案匯出為 PowerPoint 簡報 (PPTX)。
