---
title: Λάβετε πλάτος και ύψος χαρτιού για εκτύπωση φύλλου εργασίας
linktitle: Λάβετε πλάτος και ύψος χαρτιού για εκτύπωση φύλλου εργασίας
second_title: Aspose.Cells .NET Excel Processing API
description: Μάθετε πώς να λαμβάνετε το πλάτος και το ύψος του χαρτιού για εκτύπωση φύλλου εργασίας στο Aspose.Cells για .NET με αυτόν τον οδηγό βήμα προς βήμα.
weight: 16
...
Βεβαιωθείτε ότι έχετε εγκαταστήσει τη βιβλιοθήκη Aspose.Cells στο έργο σας. Εάν δεν το έχετε κάνει ακόμα, μπορείτε να κάνετε λήψη της πιο πρόσφατης έκδοσης από το[Σελίδα λήψης Aspose.Cells](https://releases.aspose.com/cells/net/).
### 3. Visual Studio IDE
...
### 4. Μια έγκυρη άδεια Aspose
 Ενώ τα Aspose.Cells μπορούν να δοκιμαστούν, σκεφτείτε να αγοράσετε μια άδεια εάν τη χρησιμοποιείτε για μακροπρόθεσμα έργα. Μπορείτε να το αγοράσετε μέσω[αυτόν τον σύνδεσμο](https://purchase.aspose.com/buy) ή εξερευνήστε α[προσωρινή άδεια](https://purchase.aspose.com/temporary-license/) για σύντομες φάσεις δοκιμής.
Μόλις είστε έτοιμοι, ας μπούμε στον κώδικα!
## Εισαγωγή πακέτων
...
Ξεκινάμε δημιουργώντας ένα παράδειγμα του`Workbook` τάξη. Αυτό αποτελεί τη βάση του χειρισμού αρχείων Excel.
```csharp
...
```
 Μετά από αυτή τη ρύθμιση, χρησιμοποιούμε`Console.WriteLine` για να εμφανίσετε τις διαστάσεις. Όταν το εκτελέσετε, θα δείτε το πλάτος και το ύψος σε ίντσες για μέγεθος χαρτιού Α2.
...
Ξεκινήστε κάνοντας λήψη της βιβλιοθήκης από το[Aspose website](https://releases.aspose.com/cells/net/) και ακολουθήστε την τεκμηρίωση για να το ρυθμίσετε στο έργο σας.
...
### Πού μπορώ να βρω περισσότερους πόρους ή υποστήριξη για το Aspose.Cells;
 Μπορείτε να ελέγξετε το[Aspose φόρουμ](https://forum.aspose.com/c/cells/9) για κοινοτική βοήθεια και την[απόδειξη με έγγραφα](https://reference.aspose.com/cells/net/) για μαθήματα και υλικά αναφοράς.
