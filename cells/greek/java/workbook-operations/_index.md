...
### [Java: δημιουργία αρχείου Excel, προσθήκη προσαρμοσμένης ιδιότητας και αποθήκευση ως XLSB](./java-create-excel-file-add-custom-property-and-save-as-xlsb/)
Μάθετε πώς να δημιουργήσετε αρχείο Excel, να προσθέσετε προσαρμοσμένη ιδιότητα και να το αποθηκεύσετε ως XLSB με το Aspose.Cells για Java.
