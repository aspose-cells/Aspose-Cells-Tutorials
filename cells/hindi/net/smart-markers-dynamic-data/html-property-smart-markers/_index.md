---
title: स्मार्ट मार्करों में HTML प्रॉपर्टी का उपयोग करें Aspose.Cells .NET
linktitle: स्मार्ट मार्करों में HTML प्रॉपर्टी का उपयोग करें Aspose.Cells .NET
...
# स्मार्ट मार्करों में HTML प्रॉपर्टी का उपयोग करें Aspose.Cells .NET
...
using System;
```
ये नामस्थान आपको Aspose.Cells की सभी सुविधाओं के साथ काम करने की अनुमति देंगे जिनका हम इस ट्यूटोरियल में उपयोग करेंगे।
...
1. किसी सेल में स्मार्ट मार्कर रखें: इस चरण में, आप परिभाषित करेंगे कि आपके एक्सेल शीट में स्मार्ट मार्कर कहाँ रखा जाएगा।
```csharp
...
हां, जब तक आप स्मार्ट मार्कर को सही ढंग से फॉर्मेट करते हैं, आप किसी भी सेल में HTML का उपयोग कर सकते हैं।
