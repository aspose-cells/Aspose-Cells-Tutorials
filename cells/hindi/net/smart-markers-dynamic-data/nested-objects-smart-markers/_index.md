...
### नेस्टेड ऑब्जेक्ट्स का संग्रह बनाएँ
 अब मज़ेदार हिस्सा आता है - नेस्टेड ऑब्जेक्ट्स के साथ डेटा स्रोत बनाना। आप एक संग्रह बनाएँगे`Individual` वस्तुएं, जिनमें से प्रत्येक में एक`Wife` आइए पहले इन क्लासों को तैयार करें।
```csharp
...
```
 पैरामीटर सेट किया गया`false` यह इंगित करता है कि डेटा स्रोत लागू होने के बाद हम किसी भी सेल सूत्र को संसाधित नहीं करना चाहते हैं।
