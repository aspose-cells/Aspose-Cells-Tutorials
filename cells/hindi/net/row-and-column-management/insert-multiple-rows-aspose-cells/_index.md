...
```
`Workbook`क्लास Aspose.Cells लाइब्रेरी का दिल है। यह एक्सेल फ़ाइल का प्रतिनिधित्व करता है और आपको इसकी सामग्री तक पहुँच प्रदान करता है। फ़ाइल स्ट्रीम को पास करके`Workbook` कन्स्ट्रक्टर का उपयोग करके, हम एक्सेल फ़ाइल को मेमोरी में लोड करते हैं।
...
```
`InsertRows` विधि दो पैरामीटर लेती है: वह इंडेक्स जिस पर आप पंक्तियाँ डालना शुरू करना चाहते हैं और डालने के लिए पंक्तियों की संख्या। इस मामले में, हम इंडेक्स से शुरू करते हैं`2` (तीसरी पंक्ति, क्योंकि यह शून्य-अनुक्रमित है) और डालें`10` पंक्तियाँ.
...
```
`Save` विधि कार्यपुस्तिका में किए गए परिवर्तनों को सहेजती है। यहाँ, हम इसे इस रूप में सहेज रहे हैं`output.out.xls` उसी निर्देशिका में. 
