...
```
The `dataDir` वेरिएबल उस पथ को संग्रहीत करेगा जहाँ आप अंतिम एक्सेल फ़ाइल को सहेजेंगे। सुनिश्चित करें कि आप "आपकी दस्तावेज़ निर्देशिका" को अपने सिस्टम पर वास्तविक पथ से बदल दें।
...
ws1.Copy(ws0);
```
The `Copy` विधि स्रोत वर्कशीट से सभी सामग्री लेती है (`ws0`) और इसे गंतव्य वर्कशीट में डुप्लिकेट करता है (`ws1`) बहुत आसान है, है ना?
