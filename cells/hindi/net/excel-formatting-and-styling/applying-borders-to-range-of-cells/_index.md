...
सब कुछ तैयार है? बढ़िया! चलिए मज़ेदार भाग पर चलते हैं - आवश्यक पैकेज आयात करना।
## पैकेज आयात करें
...
```
The `Workbook` क्लास आपकी एक्सेल फ़ाइल का प्रतिनिधित्व करने वाला आपका प्राथमिक ऑब्जेक्ट है। इसे इंस्टेंटिएट करने से आप अपनी वर्कबुक पर काम कर सकते हैं।
...
अब समय आ गया है कि आप उन सेल की रेंज को परिभाषित करें जिन्हें आप बॉर्डर के साथ स्टाइल करना चाहते हैं। यहाँ, हम सेल "A1" से शुरू होकर तीसरे कॉलम तक विस्तारित एक रेंज बनाएंगे।
```csharp
