...
```
-  हम सेल में वर्तमान सिस्टम दिनांक जोड़ते हैं`A1` का उपयोग करते हुए`PutValue(DateTime.Now)`.
...
हां, Aspose.Cells आपको एक शैली को कक्षों की श्रेणी में लागू करने की अनुमति देता है`Range.SetStyle()` तरीका।
