...
4.  नमूना एक्सेल फ़ाइल: एक नमूना एक्सेल फ़ाइल (जैसे`ThreadedCommentsSample.xlsx`) आपकी निर्देशिका में सहेजा गया है जिसमें परीक्षण के उद्देश्य से थ्रेडेड टिप्पणियाँ हैं।
## पैकेज आयात करना
...
## चरण 2: वर्कबुक ऑब्जेक्ट बनाएँ
 एक बार जब आप निर्देशिका स्थापित कर लेते हैं, तो अगला कार्य एक निर्देशिका बनाना है`Workbook` ऑब्जेक्ट. यह ऑब्जेक्ट आपको एक्सेल फ़ाइल को लोड करने और उसमें हेरफेर करने की अनुमति देता है. 
```csharp
