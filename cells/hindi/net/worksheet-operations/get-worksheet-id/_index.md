...
```
`Workbook` Aspose.Cells में क्लास एक्सेल फ़ाइल का प्रतिनिधित्व करता है। जब हम इसका नया इंस्टेंस बनाते हैं`Workbook` और इसे फ़ाइल का पथ दें, यह आपकी एक्सेल फ़ाइल को पढ़ता है और उसे हेरफेर के लिए तैयार करता है।
...
```
`UniqueId` की संपत्ति`Worksheet`क्लास उस शीट के लिए अद्वितीय पहचानकर्ता रखता है। इसे कंसोल पर प्रिंट करके, आप आईडी देख सकते हैं और सत्यापित कर सकते हैं कि यह सही तरीके से काम कर रहा है। 
## निष्कर्ष
