...
## चरण 2: कार्यपुस्तिका लोड करें
 अगला, एक नया आरंभ करें`Workbook` वह ऑब्जेक्ट जो आपकी स्रोत एक्सेल फ़ाइल की ओर इशारा करता है। यह ऑब्जेक्ट आपकी स्प्रेडशीट तक पहुँचने और उसमें हेरफेर करने के लिए केंद्रीय केंद्र के रूप में काम करेगा।
```csharp
