...
## चरण 2: वर्कबुक ऑब्जेक्ट को इंस्टैंशिएट करें
 इसके बाद, हम एक बनाएंगे`Workbook` हम जिस एक्सेल फ़ाइल पर काम कर रहे हैं उसे खोलने के लिए ऑब्जेक्ट का उपयोग करें।
```csharp
...
```
`Hyperlinks` एक की संपत्ति`Range` ऑब्जेक्ट एक सरणी लौटाता है`Hyperlink`उस सीमा में पाई जाने वाली वस्तुएँ। यह आपके पृष्ठ से सभी महत्वपूर्ण नोट्स को एक बार में हथियाने जैसा है!
