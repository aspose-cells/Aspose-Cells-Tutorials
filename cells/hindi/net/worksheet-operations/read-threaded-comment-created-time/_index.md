...
इसके बाद, आप एक्सेल वर्कबुक लोड करेंगे जिसमें थ्रेडेड टिप्पणियाँ शामिल हैं। आप इसे इस प्रकार कर सकते हैं:
```csharp
...
थ्रेडेड टिप्पणियों को प्राप्त करने के बाद, अब हम उनमें लूप कर सकते हैं और निर्मित समय सहित विवरण प्रदर्शित कर सकते हैं:
```csharp
