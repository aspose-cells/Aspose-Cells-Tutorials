...
## आवश्यक शर्तें
इससे पहले कि हम कोड में कूदें, आपको इस ट्यूटोरियल को सुचारू रूप से चलाने के लिए निम्नलिखित बातों की आवश्यकता होगी:
...
इसके बाद, हमें एक नई वर्कबुक ऑब्जेक्ट बनाने की ज़रूरत है। वर्कबुक को अपने खाली कैनवास के रूप में सोचें जहाँ सारा जादू होता है!
```csharp
...
अंत में, अब सारी मेहनत को सहेजने का समय आ गया है! यह लाइन आपकी कार्यपुस्तिका को HTML फ़ाइल के रूप में निर्दिष्ट आउटपुट निर्देशिका में सहेजती है।
```csharp
...
```
अब आप अपना कोड चला सकते हैं, और यदि आपको पुष्टिकरण संदेश दिखाई देता है, तो बधाई हो - आपने अपनी एक्सेल वर्कशीट को अलग CSS के साथ सफलतापूर्वक निर्यात कर लिया है!
## निष्कर्ष
