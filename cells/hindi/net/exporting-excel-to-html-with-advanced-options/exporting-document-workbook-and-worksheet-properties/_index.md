...
- The `Save` विधि दो पैरामीटर लेती है: आउटपुट HTML फ़ाइल के लिए फ़ाइल पथ और हमारे द्वारा सेट किए गए विकल्प। इसे चलाने से आपकी HTML फ़ाइल निर्दिष्ट आउटपुट निर्देशिका में बन जाएगी।
...
हाँ, Aspose.Cells विभिन्न विकल्प प्रदान करता है `HtmlSaveOptions` अपनी एक्सेल फ़ाइल को HTML में रूपांतरित करने के तरीके को अनुकूलित करने के लिए क्लिक करें.
...
Aspose.Cells पीडीएफ, सीएसवी, एक्सएमएल, और अन्य सहित विभिन्न प्रारूपों का समर्थन करता है।
