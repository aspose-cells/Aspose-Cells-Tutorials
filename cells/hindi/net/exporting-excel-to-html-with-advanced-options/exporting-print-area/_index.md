...
```
The `Worksheets` संग्रह आपको कार्यपुस्तिका में अलग-अलग शीट तक पहुंचने की अनुमति देता है। इस मामले में, हम पहली शीट (इंडेक्स) को पकड़ रहे हैं `0`). 
...
```
The `HtmlSaveOptions` क्लास कार्यपुस्तिका को HTML प्रारूप में सहेजने के लिए विभिन्न सेटिंग्स प्रदान करता है, जिससे आउटपुट कैसा दिखना चाहिए, इसके लिए बारीक समायोजन की सुविधा मिलती है।
