...
category: general
date: 2026-03-22
description: सिर्फ कुछ चरणों में एक्सेल को पावरपॉइंट में निर्यात करना, एक्सेल में
  प्रिंट एरिया सेट करना, और एक्सेल को संपादन योग्य चार्ट और OLE ऑब्जेक्ट्स के साथ
  PPTX के रूप में सहेजना सीखें।
draft: false
keywords:
...
- OLE objects export
language: hi
og_description: एक्सेल को जल्दी से पावरपॉइंट में निर्यात करें। यह ट्यूटोरियल दिखाता
  है कि एक्सेल में प्रिंट एरिया कैसे सेट करें और एक्सेल को PPTX के रूप में सहेजें
  जिसमें संपादन योग्य चार्ट और OLE ऑब्जेक्ट्स हों।
og_title: एक्सेल को पावरपॉइंट में निर्यात – पूर्ण C# गाइड
tags:
- Aspose.Cells
- C#
- Office Automation
title: एक्सेल को पावरपॉइंट में निर्यात – पूर्ण C# गाइड
url: /hi/net/converting-excel-files-to-other-formats/export-excel-to-powerpoint-complete-c-guide/
---
...
# Excel को PowerPoint में निर्यात करें – पूर्ण C# गाइड
