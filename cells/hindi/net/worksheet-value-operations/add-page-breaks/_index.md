...
- .NET के लिए Aspose.Cells: आपके पास Aspose.Cells लाइब्रेरी इंस्टॉल होनी चाहिए। अगर आपने अभी तक ऐसा नहीं किया है, तो चिंता न करें! आप आरंभ करने के लिए एक निःशुल्क परीक्षण संस्करण डाउनलोड कर सकते हैं। (आप इसे प्राप्त कर सकते हैं [यहाँ](https://releases.aspose.com/cells/net/)).
...
- The `Workbook` ऑब्जेक्ट बनाया जाता है, जिसका उपयोग आपकी एक्सेल फ़ाइल को रखने और उसमें हेरफेर करने के लिए किया जाएगा।
...
```
यहाँ:
- The `VerticalPageBreaks.Add("Y30")` विधि कॉलम Y पर एक लंबवत पृष्ठ विराम जोड़ती है (यानी, 25वें कॉलम के बाद)। यह कॉलम X और Y के बीच एक पृष्ठ विराम बनाएगा।
...
आप बस कॉल करके कई पेज ब्रेक जोड़ सकते हैं `HयाizontalPageBreaks.Add()` or `VerticalPageBreaks.Add()` विभिन्न सेल संदर्भों के साथ कई बार विधियाँ।
...
आप इसका उपयोग करके पृष्ठ विराम हटा सकते हैं `HयाizontalPageBreaks.RemoveAt()` or `VerticalPageBreaks.RemoveAt()` आप जिस पेज ब्रेक को हटाना चाहते हैं उसका इंडेक्स निर्दिष्ट करके विधि का चयन कर सकते हैं।
