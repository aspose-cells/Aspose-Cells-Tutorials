...
```
The `Worksheets` कलेक्शन हमें किसी भी शीट को उसके इंडेक्स (0 से शुरू) द्वारा पकड़ने की अनुमति देता है। यहाँ, हम केवल पहला ले रहे हैं।
...
```
The `Clear()` यह विधि रीसेट बटन दबाने के समान है, जो हमें अपने डेटा फ़ील्ड के साथ नए सिरे से शुरुआत करने की अनुमति देती है।
...
```
The `RefreshData()` विधि वर्तमान डेटा लाती है और पिवट तालिका को अपडेट करती है। इस बीच, `CalculateData()` किसी भी आवश्यक गणना को संसाधित करता है।
...
Aspose.Cells for .NET एक्सेल फ़ाइल हेरफेर के लिए एक लाइब्रेरी है, जो उपयोगकर्ताओं को एक्सेल फाइलें बनाने, संपादित करने, परिवर्तित करने और प्रिंट करने की अनुमति देता है।
