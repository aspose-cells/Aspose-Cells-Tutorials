...
```
 इस पंक्ति में, हम कार्यपुस्तिका को का उपयोग करके सहेजते हैं`Save` विधि.`SaveFormat.Excel97To2003` यह सुनिश्चित करता है कि कार्यपुस्तिका पुराने Excel प्रारूप में सहेजी गई है, जो संगतता की चिंता होने पर उपयोगी हो सकती है। यदि आप Excel के नए संस्करण का उपयोग कर रहे हैं तो प्रारूप बदलें।
## निष्कर्ष
