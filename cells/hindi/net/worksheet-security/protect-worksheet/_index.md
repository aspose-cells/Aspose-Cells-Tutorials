...
```
 इस स्थिति में, हम कार्यपुस्तिका में पहली कार्यपत्रिका (सूचकांक) तक पहुंच रहे हैं`0` यदि आप किसी अन्य वर्कशीट के साथ काम करना चाहते हैं, तो सही शीट से मिलान करने के लिए बस इंडेक्स नंबर को बदल दें।
## चरण 5: वर्कशीट को पासवर्ड से सुरक्षित करें
 यह वह महत्वपूर्ण चरण है जहाँ सुरक्षा की भूमिका आती है। आप वर्कशीट को सुरक्षित करने के लिए निम्न का उपयोग कर सकते हैं`Protect` विधि और पासवर्ड निर्दिष्ट करना। यह पासवर्ड अनधिकृत उपयोगकर्ताओं को वर्कशीट को असुरक्षित और संशोधित करने से रोकेगा।
```csharp
