...
## पैकेज आयात करें
आरंभ करने के लिए, आपको अपने C# प्रोजेक्ट में आवश्यक Aspose.Cells नामस्थानों को आयात करना होगा। ये नामस्थान आपको Excel फ़ाइल के साथ इंटरैक्ट करने, शैलियाँ लागू करने और स्तंभों की सुरक्षा करने की अनुमति देते हैं।
...
अब जब हमने डायरेक्टरी सेट कर ली है, तो अगला कदम एक नई वर्कबुक बनाना है। वर्कबुक में एक या उससे ज़्यादा वर्कशीट होंगी, और हम शुरुआत में सबसे पहले वर्कशीट पर ध्यान देंगे।
```csharp
...
```
The `Workbook` ऑब्जेक्ट संपूर्ण एक्सेल फ़ाइल का प्रतिनिधित्व करता है, जबकि `Worksheet` ऑब्जेक्ट हमें उस कार्यपुस्तिका के भीतर अलग-अलग शीट के साथ इंटरैक्ट करने की अनुमति देता है। यहाँ, हम पहली वर्कशीट तक पहुँच रहे हैं (`Worksheets[0]`).
...
```
यहाँ, हम सभी कॉलमों (0 से 255) में लूप करते हैं और सेट करते हैं `IsLocked` संपत्ति को `false`. द `StyleFlag` ऑब्जेक्ट का उपयोग लॉक शैली को लागू करने के लिए किया जाता है, और हम इसे सेट करते हैं `true` यह इंगित करने के लिए कि कॉलम अब अनलॉक हो गए हैं। यह सुनिश्चित करता है कि कोई भी कॉलम डिफ़ॉल्ट रूप से लॉक नहीं है।
