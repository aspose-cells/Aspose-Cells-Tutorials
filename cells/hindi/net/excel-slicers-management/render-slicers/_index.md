...
```
यह चरण कार्यपुस्तिका की पहली वर्कशीट प्राप्त करता है और इसे असाइन करता है `ws` यदि आपका स्लाइसर किसी भिन्न शीट पर है, तो इंडेक्स को उसके अनुसार समायोजित करें।
...
```csharp
// छवि या प्रिंट विकल्प निर्दिष्ट करें, प्रति शीट एक पृष्ठ तथा केवल क्षेत्र को सत्य पर सेट करें।
...
```
यह कमांड वर्कशीट के पहले पेज को एक इमेज के रूप में रेंडर करता है और इसे आपके निर्दिष्ट आउटपुट डायरेक्टरी में "outputRenderingSlicer.png" के अंतर्गत सहेजता है। कंसोल संदेश पुष्टि करेगा कि निष्पादन सफलतापूर्वक पूरा हो गया है।
## निष्कर्ष
