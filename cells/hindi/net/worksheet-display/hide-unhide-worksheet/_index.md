...
```
 इस पंक्ति में, प्रतिस्थापित करें`book1.xls` अपनी एक्सेल फ़ाइल के नाम के साथ। कोड की यह पंक्ति आपकी रुचि वाली एक्सेल फ़ाइल को खोलती है और उसे प्रोसेसिंग के लिए तैयार करती है।
...
```
 यह पंक्ति संशोधित कार्यपुस्तिका को डिफ़ॉल्ट Excel 2003 प्रारूप में सहेजती है। फ़ाइल का नाम बदलने के लिए स्वतंत्र महसूस करें (जैसे`output.out.xls`) को कुछ अधिक सार्थक बनाइये।
