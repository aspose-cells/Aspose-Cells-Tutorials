...
```
इसे सेट करना `false` इससे टैब पूरी तरह छिप जाएंगे, लेकिन हम चाहते हैं कि वे अभी दिखाई दें।
...
```
मूल्य `800` यह सिर्फ़ एक उदाहरण है। इसे आज़माकर देखें कि आपके लेआउट के लिए सबसे अच्छा क्या काम करता है!
...
### अगर मैं सेट करूँ तो क्या होगा? `ShowTabs` झूठा?
