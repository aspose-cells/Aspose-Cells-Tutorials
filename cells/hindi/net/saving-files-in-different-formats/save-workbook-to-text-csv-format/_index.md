...
```
`Workbook` Aspose.Cells लाइब्रेरी से क्लास एक्सेल वर्कबुक में हेरफेर और एक्सेस की अनुमति देता है। फ़ाइल पथ को पास करके, हम प्रोसेसिंग के लिए निर्दिष्ट वर्कबुक लोड कर रहे हैं।
...
## चरण 5: प्रत्येक वर्कशीट पर पुनरावृत्ति करें
 इसके बाद, हम कार्यपुस्तिका के भीतर सभी कार्यपत्रकों को दोहराएंगे, और प्रत्येक को अपने पास सहेज लेंगे।`workbookData` array में कार्य करना है, लेकिन आपको पहले यह चुनना होगा कि किस वर्कशीट पर कार्य करना है।
```csharp
...
```
`ms.Position = 0;` लिखने के बाद पढ़ने के लिए स्थिति को रीसेट करता है। फिर, हम उपयोग करते हैं`ToArray()` मेमोरी स्ट्रीम को बाइट ऐरे में परिवर्तित करना जो वर्कशीट डेटा रखता है।
