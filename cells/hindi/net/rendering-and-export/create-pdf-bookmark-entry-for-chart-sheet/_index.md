...
इसके बाद, हमें उस एक्सेल वर्कबुक को लोड करना होगा जिसे आप संचालित करना चाहते हैं।
```csharp
...
opts.Bookmark = ent1;
```
`PdfSaveOptions` कॉन्फ़िगरेशन हमें पीडीएफ को सहेजते समय बुकमार्क शामिल करने की अनुमति देता है।
