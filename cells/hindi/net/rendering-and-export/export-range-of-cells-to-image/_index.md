...
```
The `Worksheets` संग्रह 0-अनुक्रमित है, जिसका अर्थ है कि `Worksheets[0]` हमें पहली शीट मिलती है। यदि आप कोई अलग शीट चाहते हैं तो आप इंडेक्स को समायोजित कर सकते हैं।
