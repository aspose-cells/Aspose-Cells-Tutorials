...
```
 उपरोक्त कोड में, हम कार्यपुस्तिका को निर्दिष्ट निर्देशिका में नाम से सहेज रहे हैं`SetPageOrder_out.xls` । प्रतिस्थापित करें`"Your Document Directory"` उस पथ के साथ जहाँ आप अपनी फ़ाइल सहेजना चाहते हैं.
...
### ओवरदैनडाउन के अलावा प्रिंट ऑर्डर के लिए अन्य विकल्प क्या हैं?
 वैकल्पिक विकल्प है`DownThenOver`, जो पहले कॉलम के नीचे, फिर पंक्तियों के पार प्रिंट करेगा।
