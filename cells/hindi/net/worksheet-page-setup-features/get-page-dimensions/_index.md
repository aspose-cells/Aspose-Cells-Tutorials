...
```
`Worksheets` संग्रह में`Workbook` हमें इंडेक्स द्वारा प्रत्येक वर्कशीट तक पहुंचने की अनुमति देता है। यहां, हम पेज आयाम सेट करना शुरू करने के लिए पहली शीट लेते हैं।
...
```
 यहाँ, हम बदलते हैं`PaperSize` संपत्ति को`PaperA2` आकार निर्धारित करने के बाद,`PageSetup.PaperWidth` और`PageSetup.PaperHeight` शीट की चौड़ाई और ऊंचाई इंच में प्राप्त करें। इससे हमें पेज के आयामों का त्वरित अवलोकन मिलता है।
...
### मैं Aspose.Cells में पृष्ठ का ओरिएंटेशन कैसे बदल सकता हूँ?  
 आप इसका उपयोग करके अभिविन्यास बदल सकते हैं`PageSetup.Orientation` संपत्ति, इसे या तो सेट करना`PageOrientationType.Portrait` या`PageOrientationType.Landscape`.
