...
यहाँ से चीज़ें दिलचस्प हो जाती हैं। हम एक बनाएंगे `CustomerDataSource` वर्ग कार्यान्वयन `ICellsDataTable` हमारे डेटा को Aspose.Cells के कार्यपुस्तिका डिजाइनर के साथ संगत बनाने के लिए।
```csharp
...
```
The `SetDataSource` विधि हमारे बांधता है `CustomerDataSource` कार्यपुस्तिका में स्मार्ट मार्करों के लिए। प्रत्येक मार्कर लेबल `&=Customer` एक्सेल में अब संबंधित ग्राहक डेटा द्वारा प्रतिस्थापित किया जाएगा।
...
### क्या है `ICellsDataTable` Aspose.Cells में?  
