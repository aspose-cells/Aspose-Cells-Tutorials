...
```
`ProtectSharedWorkbook` यहाँ पासवर्ड के साथ विधि का उपयोग किया गया है`"1234"` इसका मतलब है कि साझा कार्यपुस्तिका को संपादित करने के लिए, किसी को यह पासवर्ड जानना होगा। इसे अपना डिजिटल लॉक समझें!
...
```
`Save` विधि कार्यपुस्तिका को आपकी निर्दिष्ट आउटपुट निर्देशिका में सहेजती है, और फ़ाइल को नाम देती है`outputProtectSharedWorkbook.xlsx`अब आप अपनी फ़ाइल को वहां रख सकते हैं जहां आप चाहते थे!
