...
हमारे प्रोग्रामिंग एडवेंचर में पहला कदम आवश्यक पैकेजों को आयात करना है। C# में, इसका मतलब है कि आप अपने प्रोजेक्ट में उपयोग की जाने वाली लाइब्रेरीज़ के संदर्भ जोड़ना। यहाँ बताया गया है कि आप यह कैसे कर सकते हैं:
...
सबसे पहले सबसे पहले! आपको यह परिभाषित करना होगा कि आपकी एक्सेल फ़ाइलें कहाँ संग्रहीत हैं और संशोधित फ़ाइल को कहाँ सहेजना है। कोड में, यह इस तरह दिखता है:
...
- संपूर्ण शब्द "KIM" खोजें (धन्यवाद `\\b` सीमाओं) को हटा दें और इसे "^^^TIM^^^" से बदल दें। 
...
रेगेक्स आपको जटिल खोज-और-प्रतिस्थापन संचालन करने की अनुमति देता है जो सरल पाठ मिलान से कहीं आगे जाता है, जिससे यह डेटा प्रोसेसिंग कार्यों के लिए एकदम उपयुक्त है।
