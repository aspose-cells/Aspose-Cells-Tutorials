...
using System;
```
ये पैकेज Aspose.Cells लाइब्रेरी का उपयोग करके Excel फ़ाइलों के साथ काम करने के लिए आवश्यक हैं। `Aspose.Cells` नेमस्पेस में वे सभी क्लासेस शामिल हैं जिनकी आपको एक्सेल फाइलों में हेरफेर करने के लिए आवश्यकता है, जबकि `Aspose.Cells.Xlsb` XLSB प्रारूप में फ़ाइलों को सहेजने के लिए विकल्प प्रदान करता है।
