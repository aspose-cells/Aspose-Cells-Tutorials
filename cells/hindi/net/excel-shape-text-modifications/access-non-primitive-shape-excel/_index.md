...
अब जबकि हमने अपना दस्तावेज़ पथ सेट कर लिया है, अब कार्यपुस्तिका लोड करने का समय है। आप इसे इस प्रकार कर सकते हैं:
```csharp
...
```
यह पंक्ति आपकी कार्यपुस्तिका में पहली वर्कशीट तक पहुंचती है - एक्सेल सबसे अच्छा काम करता है जब हम एक समय में एक शीट पर अपना ध्यान सीमित करते हैं।
...
## चरण 5: जाँच करें कि क्या आकृति गैर-आदिम है
...
अब जब हमने पुष्टि कर ली है कि यह एक गैर-आदिम आकार है, तो हम इसके डेटा तक पहुंच सकते हैं।
```csharp
