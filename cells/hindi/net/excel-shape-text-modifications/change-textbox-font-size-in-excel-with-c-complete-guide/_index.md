...
category: general
date: 2026-05-30
description: C# का उपयोग करके Excel में टेक्स्टबॉक्स फ़ॉन्ट आकार बदलें। चरण‑दर‑चरण
  कोड के साथ Excel टेक्स्टबॉक्स फ़ॉन्ट को जल्दी से संशोधित करना सीखें।
draft: false
keywords:
- change textbox font size
- modify excel textbox font
language: hi
og_description: C# का उपयोग करके Excel में टेक्स्टबॉक्स फ़ॉन्ट आकार बदलें। यह गाइड
  दिखाता है कि Excel टेक्स्टबॉक्स फ़ॉन्ट को सुरक्षित और कुशलता से कैसे संशोधित किया
  जाए।
og_title: C# के साथ Excel में टेक्स्टबॉक्स फ़ॉन्ट आकार बदलें – पूर्ण ट्यूटोरियल
schemas:
- author: Aspose
...
- C#
- Office Automation
title: C# के साथ Excel में टेक्स्टबॉक्स फ़ॉन्ट आकार बदलें – पूर्ण गाइड
url: /hi/net/excel-shape-text-modifications/change-textbox-font-size-in-excel-with-c-complete-guide/
---
...
# Excel में C# के साथ टेक्स्टबॉक्स फ़ॉन्ट आकार बदलें – पूर्ण गाइड

Need to **textbox फ़ॉन्ट आकार बदलें** in an Excel worksheet from C#? You're in the right place. Whether you're generating reports, building a dashboard, or just tweaking a template, adjusting the appearance of a textbox can make your spreadsheet look far more professional.
...
> **उपयोगी सुझाव:** If you’re targeting .NET 6+, add the `Microsoft.Office.Interop.Excel` package via `dotnet add package Microsoft.Office.Interop.Excel`. This ensures the `Excel` alias resolves correctly.
...
> **ध्यान दें:** The `Shapes` collection is 1‑based, so we add `+1` to the zero‑based `textboxIndex` you pass in. Forgetting this leads to “index out of range” errors that can be frustrating to debug.

## Step 4: Change Textbox Font Size (and Name)

Here’s where we finally **textbox फ़ॉन्ट आकार बदलें**. The `TextFrame2` property gives us access to the rich‑text formatting options, which include `Font.Name` and `Font.Size`.
...
### हम `TextFrame2` क्यों उपयोग करते हैं
...
> **उपयोगी सुझाव:** If you need to **modify excel textbox font** on many worksheets, wrap the inner logic in a loop that iterates over `Workbook.Worksheets`. Just remember to reset `textboxIndex` for each sheet.
...
### 1. शीट पर *सभी* टेक्स्टबॉक्स बदलें
...
### 2. इंडेक्स के बजाय उसके **नाम** से टेक्स्टबॉक्स पहचानें
...
*Alt text:* *Excel में टेक्स्टबॉक्स फ़ॉन्ट आकार बदलें – हाइलाइट किया गया टेक्स्टबॉक्स फ़ॉन्ट संशोधन के लिए तैयार।*
...
- [Excel में फ़ॉन्ट आकार बदलना](/cells/english/net/working-with-fonts-in-excel/changing-font-size/)
- [Aspose.Cells .NET का उपयोग करके Excel सेल्स में फ़ॉन्ट आकार को कस्टमाइज़ करने का तरीका | पूर्ण गाइड](/cells/english/net/formatting/customize-font-size-excel-aspose-cells-dotnet/)
- [Aspose.Cells for .NET (स्टेप‑बाय‑स्टेप गाइड) के साथ Excel में फ़ॉन्ट स्टाइल सेट करने का तरीका](/cells/english/net/formatting/aspose-cells-dotnet-set-font-styles-excel/)
