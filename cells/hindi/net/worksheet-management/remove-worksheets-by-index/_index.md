...
## आवश्यक शर्तें
कोड में कूदने से पहले, आपको कुछ चीजें तैयार रखनी होंगी:
...
अब जब फ़ाइल लोड हो गई है, हम इसका एक उदाहरण बनाते हैं `Workbook` क्लास। यह ऑब्जेक्ट Aspose.Cells में Excel फ़ाइलों के साथ काम करने के लिए केंद्रीय है, क्योंकि यह Excel कार्यपुस्तिका का प्रतिनिधित्व करता है और इसकी कार्यपत्रकों तक पहुँच प्रदान करता है।
```csharp
...
हां, आप एकाधिक का उपयोग कर सकते हैं `RemoveAt` शीट्स को उनके इंडेक्स के आधार पर हटाने के लिए कॉल। बस याद रखें कि शीट्स को हटाने पर इंडेक्स शिफ्ट हो जाएंगे।
...
नहीं, एक बार वर्कशीट हटा दिए जाने के बाद, वह उस वर्कबुक इंस्टेंस से हमेशा के लिए मिट जाती है। अगर आपको यकीन नहीं है तो बैकअप सेव कर लें।
