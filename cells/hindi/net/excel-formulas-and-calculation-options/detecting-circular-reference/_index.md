...
5. एक्सेल फ़ाइल: एक एक्सेल फ़ाइल तैयार रखें जिसमें परीक्षण के लिए परिपत्र संदर्भ शामिल हों। आप एक सरल फ़ाइल बना सकते हैं या एक नमूना डाउनलोड कर सकते हैं।
...
प्रक्रिया को पूरा करने के लिए, आपको निम्नलिखित को लागू करना होगा: `CircularMonitor` वर्ग। यह वर्ग इनसे विरासत में मिलेगा `AbstractCalculationMonitor` और वृत्तीय संदर्भों का पता लगाने का काम संभालते हैं।
```csharp
