...
```
The `Workbook` क्लास एक एक्सेल फ़ाइल का प्रतिनिधित्व प्रदान करता है। इसे इंस्टेंटिएट करके, हम एक खाली एक्सेल वर्कबुक बनाते हैं जिसे हम हेरफेर कर सकते हैं।
...
```
The `BuiltInDocumentPropertyCollection` क्लास अंतर्निहित दस्तावेज़ गुणों के संग्रह तक पहुंच प्रदान करता है, जैसे कि शीर्षक, लेखक और अन्य मेटाडेटा जो आमतौर पर दस्तावेज़ से जुड़े होते हैं।
...
```
The `Save` विधि का उपयोग फ़ाइल को आपकी निर्दिष्ट निर्देशिका में सहेजने के लिए किया जाता है। यहाँ, हम इसे Excel फ़ाइल के रूप में सहेज रहे हैं `.xlsx` प्रारूप। यदि आवश्यक हो, तो Aspose.Cells जैसे प्रारूपों का भी समर्थन करता है `.xls`, `.csv`, और `.pdf`, आपकी परियोजना की आवश्यकताओं के आधार पर लचीलापन प्रदान करना।
## निष्कर्ष
