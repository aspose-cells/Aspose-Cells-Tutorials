...
5. फ़ाइल सिस्टम तक पहुंच: सुनिश्चित करें कि आपके पास फ़ाइल सिस्टम तक पहुंच है जहां आप छवि को पढ़ेंगे और एक्सेल फ़ाइल को सेव करेंगे।
...
- The `FileStream` छवि को रीड मोड में खोलने के लिए उपयोग किया जाता है।
