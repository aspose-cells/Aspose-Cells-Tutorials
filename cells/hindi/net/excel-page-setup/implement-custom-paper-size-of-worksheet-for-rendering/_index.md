...
प्रतिस्थापित करना सुनिश्चित करें `"YOUR_OUTPUT_DIRECTORY"` वास्तविक पथ के साथ जहाँ आप अपना पीडीएफ दस्तावेज़ सहेजना चाहते हैं। इसे खाना पकाने से पहले एक टेबल सेट करने के रूप में सोचें; आपको काम करने के लिए एक साफ जगह की आवश्यकता है।
...
अंततः, अब समय आ गया है कि आप अपनी सारी मेहनत को पीडीएफ फाइल के रूप में सहेज लें।
