...
```
The `Add()` विधि एक नया वेब एक्सटेंशन बनाती है और उसका इंडेक्स लौटाती है। इससे आप बाद में एक्सटेंशन तक पहुँच सकते हैं।
...
- The `DockState` गुण यह निर्धारित करता है कि Excel UI में कार्य फलक कहां दिखाई देगा (इस मामले में, दाईं ओर)।
