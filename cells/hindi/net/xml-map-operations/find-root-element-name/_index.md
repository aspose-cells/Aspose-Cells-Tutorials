...
```csharp
// XML मानचित्र वाली नमूना एक्सेल फ़ाइल लोड करें
...
एक्सेल फाइल में कई XML मैप हो सकते हैं, इसलिए यहाँ हम खास तौर पर पहले XML मैप को एक्सेस करेंगे। Aspose.Cells प्रदान करता है `XmlMaps` की संपत्ति `Worksheet` इस उद्देश्य के लिए कक्षा.
```csharp
...
हाँ, Aspose एक प्रदान करता है [मुफ्त परीक्षण](https://releases.aspose.com/) लाइसेंस खरीदने से पहले Aspose.Cells को आज़माना न भूलें।
