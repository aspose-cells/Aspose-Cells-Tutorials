...
### [एक्सेल से कस्टम गुण को पीडीएफ में निर्यात करें](./export-custom-properties-to-pdf/)
...
### [C# में प्रोग्रामेटिक रूप से एक्सेल फ़ाइल बनाएं – ट्यूटोरियल](./create-excel-file-programmatically-in-c-tutorial/)
.NET के लिए Aspose.Cells का उपयोग करके C# में प्रोग्रामेटिक रूप से एक्सेल फ़ाइल बनाना सीखें।
