...
###  इसका उद्देश्य क्या है?`GlobalizationSettings` class in Aspose.Cells?
`GlobalizationSettings` Aspose.Cells में क्लास आपको अंतर्निहित Excel फ़ंक्शन के व्यवहार को अनुकूलित करने की अनुमति देता है, जिसमें स्थानीय फ़ंक्शन नाम बदलने की क्षमता भी शामिल है।
###  क्या मैं के अलावा अन्य कार्यों के व्यवहार को ओवरराइड कर सकता हूँ`SUM` and `AVERAGE`?
