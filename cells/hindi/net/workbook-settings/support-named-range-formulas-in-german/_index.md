---
"description": "जानें कि .NET के लिए Aspose.Cells का उपयोग करके जर्मन लोकेल में नामित श्रेणी फ़ार्मुलों को कैसे संभालना है। प्रोग्रामेटिक रूप से Excel फ़ाइलें बनाना, उनमें हेरफेर करना और सहेजना सीखें।"
...
4. नव निर्मित प्राप्त `Name` ऑब्जेक्ट और इसे सेट करें `RefersTo` संपत्ति को सूत्र मान में बदलें।
...
### मैं Aspose.Cells for .NET के लिए अधिक संसाधन और समर्थन कहां पा सकता हूं?
