...
आइए Aspose.Cells का उपयोग करके एक नई Excel वर्कबुक बनाकर शुरुआत करें। नीचे यह करने का एक उदाहरण दिया गया है:
...
### क्या Aspose.Cells for Java विभिन्न Excel फ़ाइल स्वरूपों के साथ संगत है?
   हां, Aspose.Cells विभिन्न Excel फ़ाइल स्वरूपों का समर्थन करता है, जिसमें XLS, XLSX, XLSM, आदि शामिल हैं।
