...
`CONCATENATE`फ़ंक्शन आपको अलग-अलग सेल से टेक्स्ट मर्ज करने की अनुमति देता है। आइए देखें कि जावा के लिए Aspose.Cells के साथ यह कैसे किया जाता है:
...
`LEFT` और`RIGHT` फ़ंक्शन आपको टेक्स्ट स्ट्रिंग के बाएँ या दाएँ से निर्दिष्ट संख्या में वर्ण निकालने की अनुमति देते हैं। यहाँ बताया गया है कि आप उनका उपयोग कैसे कर सकते हैं:
...
`LEN` फ़ंक्शन टेक्स्ट स्ट्रिंग में वर्णों की संख्या गिनता है। आइए देखें कि इसे Java के लिए Aspose.Cells के साथ कैसे उपयोग किया जाए:
...
`UPPER` और`LOWER` फ़ंक्शन आपको टेक्स्ट को अपरकेस या लोअरकेस में बदलने की अनुमति देते हैं। आप यह कैसे कर सकते हैं:
...
`FIND` फ़ंक्शन आपको एक स्ट्रिंग के भीतर एक विशिष्ट वर्ण या पाठ की स्थिति का पता लगाने की अनुमति देता है, जबकि`REPLACE` फ़ंक्शन आपको टेक्स्ट बदलने में मदद करता है। आइए उन्हें क्रियान्वित होते हुए देखें:
...
सेल B5 में "9" ('के लिए' का स्थान) होगा, तथा सेल C5 में "मेरे साथ खोजें" होगा।
