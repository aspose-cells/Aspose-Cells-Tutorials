...
अब, मान लें कि आपके पास सेल A1 से A10 तक की संख्याओं की एक सीमा है, और आप उनमें से न्यूनतम मान ज्ञात करना चाहते हैं। आप इस तरह MIN फ़ंक्शन लागू करने के लिए Java के लिए Aspose.Cells का उपयोग कर सकते हैं:

```java
// श्रेणी A1:A10 पर MIN फ़ंक्शन लागू करें और परिणाम को सेल B1 में संग्रहीत करें
