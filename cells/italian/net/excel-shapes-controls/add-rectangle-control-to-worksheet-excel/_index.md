...
1.  Aspose.Cells per la libreria .NET: se non l'hai già fatto,[Scarica la libreria](https://releases.aspose.com/cells/net/) oppure installarlo utilizzando NuGet in Visual Studio.
