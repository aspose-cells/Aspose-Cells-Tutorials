...
using System.Text;
```
เมื่อคุณรวมเนมสเปซเหล่านี้ คุณจะสามารถเข้าถึงคลาสและวิธีการที่จำเป็นในการจัดการเวิร์กบุ๊ก Excel ได้
...
```
 ในขั้นตอนนี้เราจะสร้าง`Workbook` โดยชี้ไปที่ไฟล์ Excel ของเรา การดำเนินการนี้จะช่วยเตรียมการสำหรับการดำเนินการอื่นๆ ต่อไป
