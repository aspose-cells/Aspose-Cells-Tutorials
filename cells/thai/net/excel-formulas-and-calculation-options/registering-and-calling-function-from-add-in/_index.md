...
สุดท้ายแต่ไม่ท้ายสุด ก็ถึงเวลาที่จะกอบกู้ผลงานชิ้นเอกของเราแล้ว
```csharp
// บันทึกสมุดงานเป็นเอาท์พุตรูปแบบ XLSX
workbook.Save(outputDir + @"test_udf.xlsx", Aspose.Cells.SaveFormat.Xlsx);
```
ที่นี่ เรากำลังบันทึกสมุดงานของเราเป็นไฟล์ XLSX ขั้นตอนสุดท้ายนี้เหมือนกับการใส่ภาพวาดของคุณลงในกรอบและเตรียมพร้อมที่จะจัดแสดง!
