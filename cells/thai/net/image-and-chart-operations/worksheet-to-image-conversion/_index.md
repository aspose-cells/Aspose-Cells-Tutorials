...
```
ที่นี่เราจะกำหนดตัวแปรที่เรียกว่า `dataDir` ที่เก็บเส้นทางไปยังไดเรกทอรีที่เราจะเก็บไฟล์ไว้ แทนที่ `"Your Document Directory"` with the actual path on your system (e.g., "C:\\MyFiles\\").
