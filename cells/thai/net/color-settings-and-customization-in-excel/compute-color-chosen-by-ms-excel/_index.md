...
description: เรียนรู้วิธีการคำนวณสีที่เลือกโดย MS Excel โดยใช้ Aspose.Cells สำหรับ .NET ปฏิบัติตามคำแนะนำทีละขั้นตอนนี้เพื่อเข้าถึงโปรแกรมการจัดรูปแบบสีตามเงื่อนไขของ Excel
weight: 10
...
ตอนนี้เรามีทุกอย่างลงตัวแล้ว มาแบ่งงานนี้เป็นขั้นตอนที่ย่อยง่ายกัน:
...
```
 ในขั้นตอนนี้ เรากำลังสร้างอินสแตนซ์ใหม่ของ`Workbook` คลาสจาก Aspose.Cells`Workbook`คลาสนี้แสดงถึงไฟล์ Excel และด้วยการระบุเส้นทางไปยังไฟล์ของเรา เราก็สามารถโหลดไฟล์นั้นได้อย่างง่ายดายเพื่อการจัดการเพิ่มเติม
## ขั้นตอนที่ 2: เข้าถึงแผ่นงานแรก
เมื่อโหลดเวิร์กบุ๊กแล้ว เราจะต้องเข้าถึงเวิร์กชีตที่ต้องการแยกสี ในตัวอย่างนี้ เราจะทำงานกับชีตแรก
```csharp
// รับแผ่นงานแรก
...
```
 การ`GetConditionalFormattingResult()` วิธีการนี้มีความสำคัญมากในขั้นตอนนี้ โดยจะส่งคืนอ็อบเจ็กต์ที่มีผลลัพธ์ของการจัดรูปแบบตามเงื่อนไขที่นำไปใช้กับเซลล์ นี่คือจุดที่เราเริ่มแตะข้อมูลสีที่ Excel กำลังใช้
...
ใช่ Aspose.Cells พร้อมใช้งานสำหรับแพลตฟอร์มต่างๆ รวมถึง Java, C-และ Android ผ่านทาง Java
