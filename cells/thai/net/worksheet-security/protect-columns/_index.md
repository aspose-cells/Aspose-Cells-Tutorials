...
เมื่อตั้งค่าไดเรกทอรีเรียบร้อยแล้ว เรามาสร้างเวิร์กบุ๊กใหม่กัน เวิร์กบุ๊กนี้จะทำหน้าที่เป็นไฟล์ฐานที่เราจะทำการเปลี่ยนแปลง
```csharp
...
```
- เวิร์กชีต[0]: เรียกค้นเวิร์กชีตแรกในเวิร์กบุ๊ก (เวิร์กชีต Excel มีดัชนีศูนย์)
...
```
- คอลัมน์ [(ไบต์)i]: การดำเนินการนี้จะเข้าถึงคอลัมน์ที่ระบุในเวิร์กชีตโดยใช้ดัชนี (เราวนซ้ำผ่านคอลัมน์ 0 ถึง 255 ที่นี่)
...
```
- คอลัมน์[0]: เข้าถึงคอลัมน์แรก (ดัชนี 0)
- style.IsLocked = true: การดำเนินการนี้จะล็อคคอลัมน์แรก เพื่อป้องกันไม่ให้ผู้ใช้ทำการเปลี่ยนแปลงใดๆ ได้
