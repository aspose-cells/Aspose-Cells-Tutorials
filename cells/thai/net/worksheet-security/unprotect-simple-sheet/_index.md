...
```
ที่นี่, `book1.xls` คือชื่อไฟล์ Excel ที่คุณต้องการยกเลิกการป้องกัน โปรดตรวจสอบให้แน่ใจว่าไฟล์มีอยู่ในไดเร็กทอรีที่ระบุ!
## ขั้นตอนที่ 3: เข้าถึงแผ่นงานแรก
ไฟล์ Excel สามารถมีแผ่นงานได้หลายแผ่น เนื่องจากเราเน้นที่แผ่นงานแรก เราจะเข้าถึงแผ่นงานนั้นโดยตรง
```csharp
