...
ในที่สุด หลังจากใช้การป้องกันแล้ว เราจะบันทึกเวิร์กบุ๊ก คุณสามารถระบุรูปแบบที่คุณต้องการบันทึกไฟล์ได้ ในตัวอย่างนี้ เราจะบันทึกเวิร์กบุ๊กเป็นไฟล์ Excel 97-2003
```csharp
// บันทึกไฟล์ Excel
...
ใช่ คุณสามารถใช้ขั้นตอนการป้องกันเดียวกันไปใช้กับหลายแถวได้ โดยการปรับเปลี่ยนลูปหรือใช้สไตล์กับแถวอื่น
...
คุณสามารถลบการป้องกันได้โดยเรียกใช้ `Unprotect` วิธีการบนแผ่นงานและให้รหัสผ่านการป้องกัน (หากมีการตั้งไว้)
