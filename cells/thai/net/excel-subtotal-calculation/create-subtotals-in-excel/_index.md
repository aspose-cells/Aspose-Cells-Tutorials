...
using Aspose.Cells;
```
การดำเนินการนี้จะนำเข้าทุกสิ่งที่เราต้องการจากไลบรารี Aspose เพื่อจัดการไฟล์ Excel ตอนนี้ มาแบ่งโค้ดออกเป็นขั้นตอนทีละขั้นตอนเพื่อสร้างผลรวมย่อยในเวิร์กชีต Excel กัน
...
ตอนนี้ลองดูสิ! คุณจะประหลาดใจว่าการจัดการข้อมูลในสเปรดชีตจะง่ายขึ้นมากแค่ไหนเมื่อคุณรู้วิธีใช้เครื่องมือที่ถูกต้อง 
## คำถามที่พบบ่อย
