...
ก่อนที่คุณจะเริ่มเขียนโค้ด ควรจัดระเบียบไฟล์เสียก่อน มาสร้างไดเรกทอรีสำหรับไฟล์ Excel ของเรากัน
```csharp
...
ต่อไปเรามาทำงานกับเซลล์ในเวิร์กชีตของเรากัน เราจะกำหนดค่าและรูปแบบบางอย่าง
```csharp
// รับเซลล์แผ่นงาน
...
Aspose.Cells นำเสนอรุ่นทดลองใช้งานฟรี แต่ต้องมีใบอนุญาตแบบชำระเงินจึงจะใช้งานจริงได้ ลองดู [ซื้อออปชั่น](https://purchase-aspose.com/buy).
