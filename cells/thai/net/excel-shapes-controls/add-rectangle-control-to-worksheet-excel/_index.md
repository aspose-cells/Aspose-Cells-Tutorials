...
สิ่งแรกที่คุณต้องทำคือกำหนดไดเรกทอรีที่จะบันทึกไฟล์ Excel ของคุณ ขั้นตอนนี้จะช่วยให้โปรเจ็กต์ของคุณทราบว่าควรสร้างและจัดเก็บไฟล์เอาต์พุตไว้ที่ใด
...
```
บล็อกนี้จะตรวจสอบว่าไดเรกทอรีนั้นมีอยู่หรือไม่ หากไม่มี ไดเรกทอรีนั้นจะสร้างไดเรกทอรีขึ้นมาใหม่ ลองนึกถึงการเตรียมตู้เอกสารให้พร้อมก่อนจัดเก็บเอกสารใดๆ
...
### ฉันสามารถตั้งค่าคุณสมบัติอื่น ๆ อะไรให้กับการควบคุมรูปสี่เหลี่ยมผืนผ้าได้บ้าง  
