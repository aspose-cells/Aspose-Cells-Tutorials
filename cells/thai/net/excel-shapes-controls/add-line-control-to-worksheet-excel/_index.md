...
## ข้อกำหนดเบื้องต้น
ก่อนที่คุณจะเริ่มเพิ่มบรรทัดลงในเวิร์กชีต Excel ของคุณ นี่คือสิ่งที่คุณต้องมี:
...
มาเริ่มเพิ่มเส้นกันก่อน เส้นแรกจะดูแข็งแรง
```csharp
...
```
อีกครั้ง เรากำหนดค่าคุณสมบัติให้คล้ายกับวิธีที่เราตั้งค่าบรรทัดก่อนหน้า
...
```
 คุณสามารถตั้งชื่อไฟล์เอาท์พุตเป็นชื่ออะไรก็ได้ตามต้องการ เพียงแต่ให้แน่ใจว่ามันลงท้ายด้วย`.xls` หรือนามสกุลไฟล์ Excel อื่น ๆ ที่รองรับ
## บทสรุป
