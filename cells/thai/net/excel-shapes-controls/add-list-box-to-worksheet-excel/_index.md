...
```
ในขั้นตอนนี้ คุณกำลังกำหนดว่าจะจัดเก็บไฟล์ของคุณไว้ที่ไหน โค้ดจะตรวจสอบว่ามีไดเรกทอรีอยู่หรือไม่ และหากไม่มี โค้ดจะสร้างไดเรกทอรีขึ้นมาใหม่ให้กับคุณ ซึ่งจะช่วยให้คุณไม่พบเจอข้อผิดพลาด "ไม่พบไฟล์" ในภายหลัง
...
```
ที่นี่ เรากำลังเพิ่มข้อความลงในเวิร์กชีต ป้ายชื่อ "เลือกแผนก:" จะถูกวางไว้ในเซลล์ B3 และแบบอักษรจะถูกตั้งค่าเป็นตัวหนา ในคอลัมน์ A เรากำลังแทรกค่าที่จะทำหน้าที่เป็นช่วงอินพุตสำหรับกล่องรายการของเรา ซึ่งแสดงถึงแผนกต่างๆ ช่วงอินพุตนี้คือช่วงที่ผู้ใช้จะเลือกเมื่อโต้ตอบกับกล่องรายการ
...
### ฉันสามารถเปลี่ยนรูปลักษณ์ของกล่องรายการได้หรือไม่  
...
คุณสามารถเข้าถึงและลบกล่องรายการจาก `Shapes` การรวบรวมโดยใช้ `sheet-Shapes.RemoveAt(index)`.
