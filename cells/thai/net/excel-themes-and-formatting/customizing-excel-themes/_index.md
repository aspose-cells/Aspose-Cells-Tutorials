...
5.  ตัวอย่างไฟล์ Excel: มีไฟล์ Excel ตัวอย่าง (เรียกว่า`book1.xlsx`) พร้อมที่จะทดสอบโค้ดของคุณ
## แพ็คเกจนำเข้า
...
ในการเริ่มต้น คุณจะต้องกำหนดตำแหน่งของไดเร็กทอรีเอกสารของคุณที่จะเก็บไฟล์ Excel:
```csharp
