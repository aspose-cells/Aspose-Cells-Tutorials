...
Aspose.Cells ใช้งานบนเวิร์กบุ๊ก (ไฟล์ Excel) เป็นหลัก หากต้องการเริ่มนำเข้าข้อมูล JSON ก่อนอื่นคุณต้องสร้างเวิร์กบุ๊กว่างที่ข้อมูลนี้จะถูกแทรกเข้าไป
```csharp
// สร้างสมุดงานเปล่า
...
```
ในขั้นตอนนี้ เราจะบันทึกเวิร์กบุ๊กเป็นไฟล์ CSV โดยระบุเส้นทางและชื่อไฟล์ (`SampleJson_out.csv`) โดยที่ CSV จะถูกบันทึกไว้
