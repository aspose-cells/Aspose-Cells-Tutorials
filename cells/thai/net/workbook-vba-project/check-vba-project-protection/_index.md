...
2.  เซลล์ Aspose สำหรับ .NET: คุณจะต้องมีไลบรารี Aspose.Cells หากคุณยังไม่ได้ดาวน์โหลด ให้ไปที่[Aspose.Cells](https://releases.aspose.com/cells/net/) เว็บไซต์ที่จะคว้าเวอร์ชั่นล่าสุด
