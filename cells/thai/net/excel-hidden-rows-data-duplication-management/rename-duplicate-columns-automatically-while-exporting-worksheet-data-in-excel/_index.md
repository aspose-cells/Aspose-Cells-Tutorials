...
"linktitle": "เปลี่ยนชื่อคอลัมน์ซ้ำโดยอัตโนมัติเมื่อส่งออกข้อมูล Excel"
"second_title": "API การประมวลผล Excel ของ Aspose.Cells .NET"
"title": "เปลี่ยนชื่อคอลัมน์ซ้ำโดยอัตโนมัติเมื่อส่งออกข้อมูล Excel"
...
```
ที่นี่ เราเพียงแค่บอกโค้ดของเราว่า "รับเวิร์กชีตแรกมาให้ฉัน" โดยทั่วไปแล้ว โปรแกรมจะอ้างอิงถึงรายการตามดัชนี ซึ่งเริ่มต้นที่ศูนย์
...
หนึ่ง `ExportTableOptions` วัตถุจะทำให้เราสามารถกำหนดวิธีการจัดการกระบวนการส่งออกได้ ซึ่งตรงนี้เราจะระบุความตั้งใจในการจัดการชื่อคอลัมน์ที่ซ้ำกันโดยอัตโนมัติ
```csharp
