...
ตอนนี้มาถึงส่วนที่น่าตื่นเต้นแล้ว นั่นก็คือการจัดตำแหน่งข้อความ! ด้วยการใช้ Aspose.Cells คุณสามารถตั้งค่าการจัดตำแหน่งแนวนอนของข้อความได้อย่างง่ายดาย
```csharp
Style style = cell.GetStyle(); // การได้รับสไตล์ปัจจุบัน
style.HorizontalAlignment = TextAlignmentType.Center; // การจัดตำแหน่งกึ่งกลาง
cell.SetStyle(style); // การประยุกต์ใช้รูปแบบ
```
