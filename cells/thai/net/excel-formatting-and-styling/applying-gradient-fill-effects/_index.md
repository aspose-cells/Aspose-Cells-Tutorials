...
```
เพียงเท่านี้คุณก็พร้อมที่จะเริ่มต้นทำการเปลี่ยนแปลงแผ่นงานของคุณได้แล้ว!
...
```
 ในโค้ดนี้ เราเปิดการเติมแบบไล่ระดับและระบุสีสองสี ได้แก่ สีขาวและสีฟ้าอันสวยงาม**Tip:** คุณสามารถเปลี่ยนสีเหล่านี้เพื่อให้เข้ากับแบรนด์หรือความชอบด้านสุนทรียศาสตร์ของคุณได้!
...
```
การทำเช่นนี้ทำให้ข้อความมีสีแดงอันโดดเด่นและตัดกับพื้นหลังแบบไล่เฉดสีได้อย่างสวยงาม
...
ทำไมไม่เพิ่มความเก๋ไก๋อีกนิดล่ะ มารวมเซลล์ B3 และ C3 เข้าด้วยกัน
```csharp
...
รุ่นทดลองใช้งานฟรีมีข้อจำกัดบางประการ รวมถึงลายน้ำบนไฟล์เอาต์พุต ควรพิจารณาซื้อใบอนุญาตเพื่อใช้ฟังก์ชันเต็มรูปแบบ
