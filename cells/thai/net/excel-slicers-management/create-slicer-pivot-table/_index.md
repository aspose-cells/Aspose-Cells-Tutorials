...
ใกล้เข้ามาแล้ว! มาสร้างตารางสรุปข้อมูลที่ต้องการเชื่อมโยงกับตัวแบ่งส่วนข้อมูลกัน
```csharp
// เข้าถึงตารางสรุปข้อมูลแรกภายในเวิร์กชีต
Aspose.Cells.Pivot.PivotTable pt = ws.PivotTables[0];
```
คำอธิบาย: เช่นเดียวกับเวิร์กชีต ตารางสรุปข้อมูลก็มีการจัดทำดัชนีเช่นกัน บรรทัดนี้จะดึงตารางสรุปข้อมูลแรกจากเวิร์กชีตเพื่อให้เราเพิ่มตัวแบ่งข้อมูลลงไปได้
...
```
 คำอธิบาย: ที่นี่ เราเพิ่มตัวแบ่งโดยระบุตำแหน่ง (เซลล์ B22) และฟิลด์ฐานจากตารางสรุปข้อมูล (อันแรก) วิธีการส่งคืนดัชนีซึ่งเราจัดเก็บใน`idx` เพื่อใช้อ้างอิงในอนาคต.
