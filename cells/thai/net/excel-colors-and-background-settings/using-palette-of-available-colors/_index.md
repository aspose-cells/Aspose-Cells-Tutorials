...
โค้ดสั้นๆ นี้จะสร้างไดเรกทอรีที่คุณต้องการบันทึกไฟล์ Excel สุดท้ายของคุณ อย่าลืมแทนที่ "ไดเรกทอรีเอกสารของคุณ" ด้วยเส้นทางจริงบนระบบของคุณ
...
เยี่ยมชมเอกสาร Aspose.Cells สำหรับ .NET ([https://reference.aspose.com/เซลล์/เน็ต/](https://reference.aspose.com/cells/net/)) สำหรับข้อมูลและตัวอย่างโค้ดเพิ่มเติม
