...
ขั้นตอนนี้ช่วยให้แน่ใจว่าคุณมีไดเร็กทอรีที่กำหนดไว้สำหรับบันทึกไฟล์ Excel ของคุณ 
```csharp
...
## ขั้นตอนที่ 9: ตั้งค่ารูปแบบแบบอักษร
...
### ฉันสามารถค้นหาการสนับสนุนสำหรับ Aspose.Cells ได้ที่ไหน  
 คุณสามารถขอความช่วยเหลือได้ที่[ฟอรั่ม Aspose](https://forum.aspose.com/c/cells/9) สำหรับคำถามใด ๆ ที่เกี่ยวข้องกับห้องสมุด
{{< /blocks/products/pf/tutorial-page-section >}}
