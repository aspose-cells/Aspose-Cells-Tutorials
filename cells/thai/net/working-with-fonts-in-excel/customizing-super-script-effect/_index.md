...
เข้าใจแล้วใช่ไหม เยี่ยมเลย มาเริ่มลงรายละเอียดกันเลย
## แพ็คเกจนำเข้า
...
cell.SetStyle(style);
```
 คิดถึง`IsSuperscript` เหมือนสวิตช์วิเศษที่ทำให้ข้อความของคุณเต้นอยู่เหนือเส้นฐาน—ฝังไว้ในความทรงจำของผู้อ่าน
