...
4. ไฟล์ Excel ตัวอย่าง: สำหรับบทช่วยสอนนี้ โปรดแน่ใจว่าคุณมีไฟล์ Excel ชื่อ `LinkTypes.xlsx`สามารถสร้างตั้งแต่ต้นหรือดาวน์โหลดจากอินเทอร์เน็ตได้
...
นี่คือสิ่งที่เกิดขึ้น: เรากำลังสร้างอินสแตนซ์ของ `Workbook` คลาสและส่งผ่านเส้นทางของไฟล์ Excel ของเรา หากทุกอย่างราบรื่น สมุดงานของคุณก็พร้อมสำหรับการใช้งานแล้ว!
