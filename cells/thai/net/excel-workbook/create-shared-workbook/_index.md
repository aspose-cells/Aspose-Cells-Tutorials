...
ก่อนที่เราจะเจาะลึกรายละเอียดในการสร้างสมุดงานที่ใช้ร่วมกัน เรามาจัดการบางสิ่งกันก่อน:
...
เมื่อคุณมีข้อกำหนดเบื้องต้นเหล่านี้แล้ว คุณก็พร้อมที่จะเริ่มสร้างเวิร์กบุ๊กที่แชร์ได้แล้ว
...
3. ตั้งชื่อโครงการของคุณเป็น "SharedWorkbookExample"
...
ในขั้นตอนนี้ คุณจะต้องกำหนดว่าจะบันทึกไฟล์เอาต์พุตไว้ที่ใด ซึ่งก็เหมือนกับการตัดสินใจว่าจะวางคุกกี้ที่เพิ่งอบเสร็จไว้ที่ไหน คุณต้องแน่ใจว่าจะค้นหาได้ง่ายในภายหลัง!
...
ต่อไปเราจะมุ่งเน้นไปที่การสร้างสมุดงาน นี่คือจุดที่ความมหัศจรรย์เกิดขึ้น!
...
```csharp
//แบ่งปันสมุดงาน
wb.การตั้งค่าs.Shared = true;
```
Setting `wb.Settings.Shared` ถึง `true` ระบุว่าผู้ใช้หลายคนสามารถเข้าถึงสมุดงานนี้ได้พร้อมๆ กัน เหมือนกับการมอบกุญแจบ้านให้เพื่อนๆ — พวกเขาสามารถเข้าและออกได้ตามต้องการ!
...
### ฉันสามารถยกเลิกการแชร์สมุดงานได้หรือไม่ หลังจากที่มีการแชร์แล้ว?
