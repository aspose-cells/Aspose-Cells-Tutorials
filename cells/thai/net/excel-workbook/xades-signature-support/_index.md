...
```
 ...
 ในสไนปเป็ตนี้ เราอ่านไฟล์ PFX ลงในอาร์เรย์ไบต์และสร้างไฟล์ใหม่`DigitalSignature` วัตถุ เรายังตั้งค่า`XAdESType` ถึง`XAdES`ซึ่งเป็นสิ่งสำคัญสำหรับการลงนามของเรา
