...
ขั้นต่อไป คุณจะต้องโหลดไฟล์ Excel ที่คุณต้องการใช้งาน นี่คือจุดเริ่มต้นของความมหัศจรรย์!
...
เมื่อคุณมีแผ่นงานแล้ว ก็ถึงเวลาเข้าถึงแผนภูมิ แผ่นงานแต่ละแผ่นสามารถมีแผนภูมิได้หลายรายการ แต่เพื่อความเรียบง่าย เราจะยึดตามแผนภูมิแรกที่นี่
...
รู้สึกอิสระที่จะทดลองกับประเภทรูปร่างที่แตกต่างกันโดยการเปลี่ยนแปลง `DataLabelShapeType.WedgeEllipseCallout` สู่ตัวเลือกอื่นที่มีให้เลือก!
