...
ในการเริ่มต้น เราต้องตั้งค่าไดเรกทอรีที่เราสามารถบันทึกไฟล์ Excel ได้ ขั้นตอนนี้ถือเป็นขั้นตอนสำคัญ เนื่องจากเราต้องการให้การทำงานของเราเป็นระเบียบ
```csharp
...
```
- Worksheets[0]: เข้าถึงเวิร์กชีตแรกในเวิร์กบุ๊ก โปรดจำไว้ว่าดัชนีมีฐานเป็นศูนย์ ดังนั้น `[0]` หมายถึงแผ่นแรก
...
ใช่ คุณสามารถปรับแต่งแบบอักษร ขนาด และสีของข้อความแสดงความคิดเห็นได้ และคุณยังสามารถเปลี่ยนรูปร่างและขนาดของความคิดเห็นนั้นได้อีกด้วย
