...
ก่อนอื่นคุณต้องกำหนดว่าจะบันทึกไฟล์ Excel ของคุณไว้ที่ใด ต่อไปนี้คือวิธีระบุ:
...
ลูปนี้จะทำงานผ่านคอลัมน์ที่เป็นไปได้ทั้งหมด (สูงสุด 256 คอลัมน์) และตั้งค่าให้สไตล์ของคอลัมน์เหล่านั้นถูกปลดล็อก ในทางหนึ่ง คุณกำลังบอกว่า "เฮ้ คุณทุกคนสามารถแก้ไขได้ตามต้องการ!"
