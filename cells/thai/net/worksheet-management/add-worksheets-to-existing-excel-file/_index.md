...
ในขั้นตอนเริ่มต้นนี้ คุณจะต้องระบุไดเรกทอรีที่ไฟล์ Excel ของคุณตั้งอยู่ นี่เป็นส่วนที่เรียบง่ายแต่จำเป็นเพื่อช่วยให้โปรแกรมของคุณค้นหาไฟล์ได้
...
## ขั้นตอนที่ 4: เพิ่มเวิร์กชีตใหม่ลงในเวิร์กบุ๊ก
 ...
 เมื่อสร้างอินสแตนซ์เวิร์กบุ๊กแล้ว ขั้นตอนต่อไปคือการเพิ่มเวิร์กชีตใหม่ ในที่นี้ Aspose.Cells จะให้วิธีง่ายๆ`Add()` วิธีการจัดการกับเรื่องนี้
