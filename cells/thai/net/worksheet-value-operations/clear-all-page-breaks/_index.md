---
title: ล้างตัวแบ่งหน้าทั้งหมดจากเวิร์กชีตโดยใช้ Aspose.Cells
linktitle: ล้างตัวแบ่งหน้าทั้งหมดจากเวิร์กชีตโดยใช้ Aspose.Cells
...
# ล้างตัวแบ่งหน้าทั้งหมดจากเวิร์กชีตโดยใช้ Aspose.Cells
...
2.  ใบอนุญาต Aspose: หากต้องการใช้งานฟังก์ชันเต็มรูปแบบนอกเหนือจากข้อจำกัดของรุ่นทดลองใช้ คุณอาจต้องสมัครใบอนุญาต คุณสามารถรับใบอนุญาตได้[ใบอนุญาตชั่วคราว](https://purchase.aspose.com/temporary-license/) หรือ[ซื้อใบอนุญาต](https://purchase.aspose.com/buy).
...
หลังจากคุณล้างการแบ่งหน้าแล้ว ก็ถึงเวลาบันทึกงานของคุณ ขั้นตอนนี้จะทำให้การเปลี่ยนแปลงเสร็จสมบูรณ์และบันทึกสมุดงานไปยังไดเร็กทอรีที่คุณระบุ
```csharp
// บันทึกไฟล์ Excel
