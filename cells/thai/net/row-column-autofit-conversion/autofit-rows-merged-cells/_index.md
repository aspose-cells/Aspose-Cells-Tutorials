...
```
บรรทัดโค้ดนี้จะสร้างเวิร์กบุ๊ก Excel ใหม่ที่ว่างเปล่าซึ่งเราสามารถเริ่มต้นใส่ข้อมูลลงไปได้
...
เพื่อให้เสร็จสิ้น เราจำเป็นต้องบันทึกงานของเรา:
```csharp
// บันทึกไฟล์ Excel
