...
2. .NET Framework: ตรวจสอบให้แน่ใจว่าคุณกำลังทำงานในโปรเจ็กต์ที่กำหนดเป้าหมายเป็นเวอร์ชันที่เข้ากันได้ของ .NET Framework Aspose.Cells เข้ากันได้กับ .NET Core, .NET Framework และแพลตฟอร์มอื่นๆ
...
```csharp
// แบ่งคอลัมน์ A ออกเป็นสองคอลัมน์โดยใช้เมธอด TextToColumns()
...
สุดท้ายนี้ เรามาบันทึกสมุดงานของเราด้วยการเปลี่ยนแปลงที่เราทำกันเถอะ การได้เห็นงานของเราได้รับการบันทึกอย่างเรียบร้อยเป็นสิ่งที่ทำให้รู้สึกพึงพอใจเสมอ!
```csharp
...
Aspose.Cells เป็นไลบรารี .NET ที่แข็งแกร่งซึ่งช่วยให้นักพัฒนาสามารถสร้าง จัดการ และแปลงสเปรดชีต Excel ได้อย่างมีประสิทธิภาพโดยไม่จำเป็นต้องติดตั้ง Microsoft Excel
