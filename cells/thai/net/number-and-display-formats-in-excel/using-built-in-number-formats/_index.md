...
using System;
```
เมื่อคุณนำเข้าไฟล์เหล่านี้แล้ว คุณก็พร้อมที่จะจัดการไฟล์ Excel ตามโปรแกรมแล้ว ตอนนี้มาดูคำแนะนำทีละขั้นตอนกันเลย!
...
```
การดำเนินการนี้จะแทรกตัวเลข 20 ลงในเซลล์ A2 คุณอาจคิดว่า "นั่นเป็นเพียงตัวเลขธรรมดา ฉันจะแปลงเป็นเปอร์เซ็นต์ได้อย่างไร" ตอนนี้เรากำลังจะเข้าสู่ขั้นตอนนั้นแล้ว
