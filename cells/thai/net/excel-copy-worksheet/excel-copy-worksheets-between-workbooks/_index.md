...
### ฉันต้องมีใบอนุญาตแบบชำระเงินเพื่อใช้ฟังก์ชันนี้หรือไม่?
 ...
 แม้ว่าคุณจะใช้ Aspose.Cells เวอร์ชันฟรีสำหรับฟังก์ชันพื้นฐานได้ แต่ขอแนะนำให้ดาวน์โหลด[ใบอนุญาตชั่วคราว](https://purchase.aspose.com/temporary-license/) หรือใบอนุญาตแบบชำระเงินเพื่อใช้ฟีเจอร์ครบถ้วนและหลีกเลี่ยงข้อจำกัดเช่นลายน้ำ
