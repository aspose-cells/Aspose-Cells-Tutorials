...
- Aspose.Cells สำหรับ .NET: ดาวน์โหลด [Aspose.Cells สำหรับ .NET](https://releases.aspose.com/cells/net/) ไลบรารีนี้มีคุณสมบัติมากมายสำหรับการจัดการไฟล์ Excel ด้วยโปรแกรม หากคุณยังไม่ได้ทำ ไลบรารีนี้มีคุณสมบัติมากมายสำหรับการจัดการไฟล์ Excel ด้วยโปรแกรม
...
```
โค้ดนี้จะดึงข้อมูล XML map แรกจากรายการ XML map ที่เชื่อมโยงกับเวิร์กบุ๊ก โดยการเข้าถึงรายการแรก (`XmlMaps[0]`) คุณกำลังเลือกแผนที่ XML แรกที่ฝังอยู่ในไฟล์ของคุณ
...
### ฉันสามารถเข้าถึงแผนที่ XML หลายรายการในไฟล์ Excel ด้วย Aspose.Cells ได้หรือไม่
