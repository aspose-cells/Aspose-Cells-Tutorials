...
## ขั้นตอนที่ 3: การซ่อนแท็บ
 ตอนนี้ สมมติว่าคุณต้องการซ่อนแท็บ (หากจำเป็น) เพื่อให้เวิร์กชีตของคุณดูเป็นระเบียบมากขึ้น คุณสามารถทำได้โดยตั้งค่า`ShowTabs` คุณสมบัติเป็นจริง (ซึ่งจะทำให้แท็บสามารถมองเห็นได้)
```csharp
...
###  จะเกิดอะไรขึ้นถ้าฉันตั้งค่า`ShowTabs` to false?
