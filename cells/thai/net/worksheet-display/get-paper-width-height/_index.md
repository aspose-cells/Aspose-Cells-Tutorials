...
using Aspose.Cells;
```
อย่าลืมใส่บรรทัดนี้ไว้ที่ด้านบนของไฟล์ .cs ตอนนี้เราก็เตรียมการนำเข้าข้อมูลเรียบร้อยแล้ว เรามาสร้างเวิร์กบุ๊กและเข้าถึงเวิร์กชีตกันเลย
...
```
บรรทัดนี้จะบอกโปรแกรมให้เริ่มต้นเวิร์กบุ๊กใหม่ เพื่อเตรียมเราให้พร้อมเข้าสู่เวิร์กชีตของเรา
...
ตอนนี้เราเข้าสู่ขั้นตอนหลักของการดำเนินการ—การตั้งค่าขนาดกระดาษและการดึงข้อมูลขนาดออกมา! มาแบ่งขั้นตอนนี้ออกเป็นขั้นตอนต่างๆ กัน
...
```
หลังจากการตั้งค่านี้เราใช้ `Console.WriteLine` เพื่อแสดงขนาด เมื่อคุณรันคำสั่งนี้ คุณจะเห็นความกว้างและความสูงเป็นนิ้วสำหรับกระดาษขนาด A2
