...
ขั้นแรก ให้ตั้งค่าไดเร็กทอรีเอาต์พุตสำหรับบันทึกไฟล์ HTML ของคุณ ซึ่งเป็นสิ่งสำคัญเพราะจะช่วยให้ทุกอย่างเป็นระเบียบ
```csharp
//ไดเรกทอรีผลลัพธ์
...
ขั้นตอนสุดท้ายก่อนสิ้นสุดคือการบันทึกเวิร์กบุ๊กเป็นไฟล์ HTML 
```csharp
//บันทึกสมุดงานในรูปแบบ HTML 
wb.Save(outputDir + "outputTableCssId.html", opts); // บันทึกด้วยตัวเลือกที่ใช้
```
ตอนนี้คุณมีการนำเสนอ HTML ของข้อมูล Excel ของคุณ พร้อมด้วยรูปแบบที่คุณตั้งค่าไว้
