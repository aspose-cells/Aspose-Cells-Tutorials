...
อย่าลืมเพิ่มการอ้างอิงถึง DLL ของ Aspose.Cells ในโปรเจ็กต์ของคุณเพื่อให้แอปพลิเคชันของคุณสามารถคอมไพล์โค้ดได้สำเร็จ
...
```
การ `Worksheets` คอลเลกชันช่วยให้คุณเข้าถึงแผ่นงานแต่ละแผ่นในเวิร์กบุ๊กได้ ในกรณีนี้ เราจะคว้าแผ่นงานแรก (ดัชนี `0`- 
