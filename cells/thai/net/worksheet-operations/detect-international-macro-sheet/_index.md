...
```
เมื่อดำเนินการตามบรรทัดนี้ ประเภทของชีตจะถูกส่งออกไปยังคอนโซล สิ่งสำคัญคือต้องจำไว้ว่าประเภทเหล่านี้หมายถึงอะไร ซึ่งคุณจะอ้างอิงข้อมูลนี้อีกครั้งในภายหลัง
...
คุณสามารถเข้าถึงการสนับสนุนได้ผ่านฟอรั่ม Aspose [ที่นี่](https://forum-aspose.com/c/cells/9).
