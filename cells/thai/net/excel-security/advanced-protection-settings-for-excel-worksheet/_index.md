...
คุณจะต้องการใช้ NuGet เพื่อเพิ่มไลบรารี Aspose.Cells คลิกขวาที่โปรเจ็กต์ของคุณใน Solution Explorer และเลือก "จัดการแพ็คเกจ NuGet"
...
ตอนนี้เรามีไฟล์สตรีมแล้ว เราสามารถสร้างได้ `Workbook` วัตถุ.
...
```
เส้นนี้จะสร้างสิ่งใหม่ `Workbook` เช่น เปิดไฟล์ที่เราระบุไว้ในขั้นตอนก่อนหน้า `Workbook` วัตถุเป็นสิ่งสำคัญเนื่องจากแสดงไฟล์ Excel ของเราในโค้ด
