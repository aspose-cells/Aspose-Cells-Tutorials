...
เมื่อคุณมีข้อกำหนดเบื้องต้นแล้ว เรามาทำการนำเข้าแพ็คเกจที่จำเป็นกัน ในกรณีนี้ เราจะเน้นที่ `Aspose.Cells` เนมสเปซ นี่คือวิธีเริ่มต้น:
...
เมื่อคุณตั้งค่าโครงการเสร็จแล้ว เรามาดูกระบวนการตั้งค่าหมายเลขหน้าแรกสำหรับเวิร์กชีตแรกในไฟล์ Excel กัน
