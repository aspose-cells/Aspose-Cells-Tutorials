...
```
## โหลดไฟล์เทมเพลต
 ต่อไปเราจะโหลดไฟล์เทมเพลต Excel ที่มีสไตล์ที่เราต้องการคัดลอก ในตัวอย่างนี้ เราจะถือว่าไฟล์เทมเพลตมีชื่อว่า "Template.xlsx" และอยู่ใน`dataDir` ไดเรกทอรี
```csharp
...
## คำถามที่พบบ่อย
###  จุดประสงค์ของการ`WorkbookDesigner` class in Aspose.Cells for .NET?
