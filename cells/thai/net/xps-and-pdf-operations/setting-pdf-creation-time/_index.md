...
```
แทนที่ `"Your Document Directory"` ด้วยเส้นทางจริงที่คุณ `Book1.xlsx` ค้นหาไฟล์แล้ว เส้นทางนี้จะช่วยให้แอปพลิเคชันค้นหาไฟล์สำหรับการประมวลผล
...
ตอนนี้ถึงเวลาสร้างอินสแตนซ์ของ `PdfSaveOptions`คลาสนี้ช่วยให้คุณสามารถระบุตัวเลือกต่างๆ ในการบันทึกเวิร์กบุ๊กของคุณเป็น PDF รวมถึงเวลาที่สร้าง
```csharp
