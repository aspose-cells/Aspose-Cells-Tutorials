...
2. Aspose.Cells สำหรับ .NET: หากคุณยังไม่ได้ติดตั้ง ให้ไปที่ [ดาวน์โหลด Aspose](https://releases.aspose.com/cells/net/) หน้าและดาวน์โหลดเวอร์ชั่นล่าสุด
...
```
ที่นี่เราจะสร้างอินสแตนซ์ใหม่ของ `PdfSaveOptions`ซึ่งช่วยให้คุณปรับแต่งรูปแบบ PDF ของคุณได้ `OnePagePerSheet` ตัวเลือกนี้มีประโยชน์สำหรับการให้แน่ใจว่าแผ่นงาน Excel แต่ละแผ่นจะมีหน้าของตัวเองใน PDF ขั้นสุดท้าย
## ขั้นตอนที่ 5: กำหนดผู้ให้บริการสตรีมของคุณ
เมื่อคุณตั้งค่าตัวเลือก PDF แล้ว คุณต้องแจ้งให้ Aspose ใช้งานผู้ให้บริการสตรีมแบบกำหนดเองสำหรับทรัพยากรภายนอก
```csharp
