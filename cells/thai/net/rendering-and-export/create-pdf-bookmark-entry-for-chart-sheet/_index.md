...
ในการจัดระเบียบโค้ดของคุณ ให้เรากำหนดว่าไฟล์ของเราอยู่ที่ไหน
```csharp
...
```
แทนที่ `Your Document Directory` พร้อมด้วยเส้นทางจริงที่คุณเก็บไฟล์ Excel ตัวอย่างและที่คุณต้องการบันทึกเอาต์พุต PDF
...
opts.Bookmark = ent1;
```
การ `PdfSaveOptions` การกำหนดค่าช่วยให้เราเพิ่มบุ๊กมาร์กได้เมื่อบันทึก PDF
