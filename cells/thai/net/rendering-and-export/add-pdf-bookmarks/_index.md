...
ในการเริ่มต้น คุณจะต้องระบุไดเร็กทอรีต้นทางและปลายทาง นี่คือที่ที่ไฟล์ Excel เริ่มต้นของคุณมีอยู่และที่ที่คุณจะบันทึก PDF
```csharp
...
```
การโหลดเวิร์กบุ๊กก็เหมือนกับการเปิดเอกสารที่มีศักยภาพมากมาย โดยให้สิทธิ์เข้าถึงเวิร์กชีต เซลล์ และความสามารถในการจัดรูปแบบของไฟล์ Excel ต้นฉบับของคุณ
