...
```
 การ`Workbook`คลาสเป็นเหมือนตัวจัดการ Excel หลักของคุณใน Aspose.Cells โดยให้การเข้าถึงแผ่นงาน สไตล์ และอื่นๆ โดยตรง
...
### ฉันสามารถเรนเดอร์หน้าในรูปแบบอื่นใดนอกจาก PNG ได้อีกหรือไม่  
 Aspose.Cells รองรับรูปแบบต่างๆ เช่น JPEG, BMP, TIFF และ GIF เพียงเปลี่ยน`ImageType` ใน`ImageOrPrintOptions`.
