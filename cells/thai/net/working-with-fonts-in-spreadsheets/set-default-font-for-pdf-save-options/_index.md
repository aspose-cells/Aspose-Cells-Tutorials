...
## ขั้นตอนที่ 4: เรนเดอร์แผ่นงานเป็นรูปภาพ
 ตอนนี้เรามาเรนเดอร์ชีตแรกของเวิร์กบุ๊กเป็นรูปภาพ PNG กัน เราจะใช้`SheetRender` ชั้นเรียนที่จะบรรลุผลนี้
```csharp
...
### ฉันจะตั้งค่าแบบอักษรเริ่มต้นให้กับไฟล์ Excel ของฉันได้อย่างไร
 คุณสามารถตั้งค่าแบบอักษรเริ่มต้นได้โดยใช้`PdfSaveOptions` คลาสและระบุชื่อฟอนต์ที่ต้องการ วิธีนี้จะช่วยให้มั่นใจว่าแม้ว่าจะไม่มีฟอนต์ใด ๆ เอกสารของคุณก็จะใช้ฟอนต์เริ่มต้นที่คุณระบุไว้
