...
ก่อนที่เราจะเจาะลึกโค้ด เรามาอิมพอร์ตเนมสเปซที่จำเป็นก่อน คุณไม่สามารถทำอะไรได้เลยใน Aspose.Cells หากไม่รวมเนมสเปซเหล่านี้
...
งานหนักทั้งหมดของคุณจะไม่มีประโยชน์อะไรหากคุณไม่บันทึกมันเอาไว้ การบันทึกเอาไว้จะช่วยให้กระจกที่แบ่งอย่างสวยงามของคุณยังคงอยู่เหมือนเดิมเพื่อการใช้งานในอนาคต
...
ใช่ แต่มาพร้อมกับข้อจำกัด หากต้องการประสบการณ์ที่ครบถ้วน ควรใช้ [ชั่วคราว](https://purchase.aspose.com/tempหรือary-license/) or [ใบอนุญาตแบบชำระเงินแล้ว](https://purchase-aspose.com/buy).
