...
รับข้อมูลอ้างอิงถึงแผ่นงานที่คุณต้องการทำงาน หากคุณกำลังทำงานกับแผ่นงานแรก:
...
การบันทึกไฟล์ของคุณเป็นสิ่งสำคัญ! บรรทัดนี้จะช่วยให้แน่ใจว่าการเปลี่ยนแปลงทั้งหมดที่คุณทำ รวมถึงบานหน้าต่างที่ตรึงไว้ จะถูกเขียนกลับไปยังไฟล์ Excel ใหม่ที่เรียกว่า `output.xls`ลองนึกถึงการปิดผนึกซองจดหมายหลังจากเขียนจดหมายสำคัญของคุณ
