...
เวิร์กบุ๊กทุกเล่มจะมีเวิร์กชีตอย่างน้อยหนึ่งแผ่น ในที่นี้เราจะอ้างอิงเวิร์กชีตแรกที่จะใช้ทำงานด้วย
...
```
 ...
 ในบรรทัดนี้เราจะระบุประเภทแผนภูมิเป็น`Pyramid` และกำหนดตำแหน่งภายในเวิร์กชีตโดยใช้ดัชนีแถวและคอลัมน์ ซึ่งก็เหมือนกับการใส่กรอบรูปบนผนัง คุณต้องเลือกตำแหน่งที่จะใส่กรอบรูปได้ดีที่สุด!
