...
วิธีการ `Add()` ยอมรับพารามิเตอร์สำหรับประเภทแผนภูมิ (ในกรณีนี้ `ChartType.Pie`) และตำแหน่งบนแผ่นงาน ตัวเลขแสดงตำแหน่งแถวและคอลัมน์
...
เราตั้งค่าการเติมไล่ระดับสำหรับพื้นที่พล็อตและซ่อนขอบเพื่อให้ดูสะอาดตายิ่งขึ้น
...
การเพิ่มป้ายกำกับลงในส่วนต่างๆ ของแผนภูมิโดยตรงจะช่วยให้เข้าใจได้ง่ายขึ้น ลองรวมชื่อภูมิภาคและมูลค่าการขายไว้ในส่วนต่างๆ ของแผนภูมิวงกลม
