...
เมื่อคุณได้ดำเนินการตามข้อกำหนดเบื้องต้นเหล่านี้เรียบร้อยแล้ว คุณก็พร้อมที่จะสร้างแผนภูมิได้แล้ว!
...
ขั้นตอนแรกคือการกำหนดว่าคุณต้องการบันทึกไฟล์เอาต์พุตไว้ที่ใด ซึ่งก็เหมือนกับการตั้งค่าพื้นที่ทำงานก่อนเริ่มลงมือทำงาน 
...
### มีฟอรั่มสำหรับการสนับสนุนหรือไม่?  
 แน่นอน! คุณสามารถหาคำตอบและถามคำถามได้ที่[ฟอรั่ม Aspose.Cells](https://forum.aspose.com/c/cells/9).
