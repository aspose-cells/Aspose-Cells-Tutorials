---
title: การเปิดไฟล์ CSV ด้วย Preferred Parser
linktitle: การเปิดไฟล์ CSV ด้วย Preferred Parser
...
```
 ที่นี่`Type` คุณสมบัติแสดงประเภทข้อมูล (เช่น`String` หรือ`DateTime` ), และ`DisplayStringValue` จะให้ค่าการจัดรูปแบบแก่คุณ
