...
```
 ...
 การ`Worksheets` คอลเลกชันช่วยให้คุณเข้าถึงแผ่นงานต่างๆ ในสมุดงานได้ ดัชนี`[0]` หมายถึงแผ่นงานแรก หากต้องการเข้าถึงแผ่นงานถัดไป คุณสามารถเปลี่ยนดัชนีได้ตามนั้น
...
-  IsBool: หากเซลล์มีค่าบูลีน เราจะเข้าถึงโดยใช้`BoolValue`.
