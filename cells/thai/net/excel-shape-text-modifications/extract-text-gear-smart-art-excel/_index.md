...
### ฉันจำเป็นต้องซื้อ Aspose.Cells สำหรับ .NET หรือไม่?
 Aspose.Cells เสนอให้ทดลองใช้งานฟรี แต่หากต้องการใช้งานต่อเนื่อง จะต้องซื้อบริการเพิ่มเติม คุณสามารถค้นหาตัวเลือกการซื้อได้[ที่นี่](https://purchase.aspose.com/buy).
