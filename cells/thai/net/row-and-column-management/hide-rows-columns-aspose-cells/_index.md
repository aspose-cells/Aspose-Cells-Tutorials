...
```
 แถวมีดัชนีเป็นศูนย์ ซึ่งหมายความว่าแถวที่สามจะถูกอ้างอิงโดย`HideRow(2)`วิธีการนี้จะซ่อนแถวโดยรักษาข้อมูลไว้เหมือนเดิมแต่ผู้ใช้จะมองไม่เห็น
...
fstream.Close();
```
การปิดสตรีมก็เหมือนกับการปิดฝาโถ ซึ่งเป็นสิ่งสำคัญในการทำให้โปรแกรมสะอาดหลังจากทำงานเสร็จ
