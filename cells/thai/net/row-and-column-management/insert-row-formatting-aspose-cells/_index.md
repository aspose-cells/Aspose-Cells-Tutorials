...
## ขั้นตอนที่ 5: ตั้งค่าตัวเลือกการจัดรูปแบบ
 ต่อไปเราต้องกำหนดว่าเราต้องการแทรกแถวใหม่อย่างไร เราจะใช้`InsertOptions` เพื่อระบุว่าเราต้องการคัดลอกการจัดรูปแบบจากแถวด้านบน
```csharp
...
```
 ที่นี่ เรากำลังบันทึกสมุดงานที่แก้ไขภายใต้ชื่อใหม่`InsertingARowWithFormatting.out.xls`เพื่อหลีกเลี่ยงการเขียนทับไฟล์ต้นฉบับ ด้วยวิธีนี้ คุณสามารถย้อนกลับได้เสมอหากจำเป็น!
