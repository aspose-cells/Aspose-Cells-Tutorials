...
### [สร้างไฟล์ Excel ด้วย C# และแปลงคอลัมน์เป็นแถว](./create-excel-workbook-c-and-transpose-column-to-row/)
คำแนะนำทีละขั้นตอนในการสร้างไฟล์ Excel ด้วย C# และแปลงข้อมูลจากคอลัมน์เป็นแถวโดยใช้ Aspose.Cells
