...
3. **ข้อกำหนดเบื้องต้นของความรู้:** ความเข้าใจพื้นฐานเกี่ยวกับการดำเนินการไฟล์ Java และ Excel
...
1. **ส่วนหัวและป้ายกำกับ:** ใส่ส่วนหัวที่ยาวลงในคอลัมน์ที่แคบได้โดยไม่ถูกตัดทอน
