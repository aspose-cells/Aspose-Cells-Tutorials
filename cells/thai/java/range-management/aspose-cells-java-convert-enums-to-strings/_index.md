...
- การแปลงค่า enum แบบครอสประเภท HTML ไปเป็นการแสดงผลแบบสตริง
...
```
### แปลงค่า Cross Type Enum ของ HTML เป็นสตริง
#### ภาพรวม
...
4. **ฉันจะจัดการหน่วยความจำได้อย่างไรเมื่อใช้ Aspose.Cells?**
   - ใช้ `Workbook.dispose()` และโหลดเฉพาะข้อมูลที่จำเป็นเพื่อประสิทธิภาพ
