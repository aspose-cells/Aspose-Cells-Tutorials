...
## แสดงข้อมูลเวอร์ชัน – ขั้นตอนของ Aspose Cells Tutorial
...
## สร้าง Workbook ว่าง – แกนหลักของ Tutorial
...
## โหลดไฟล์ Excel ที่มี VBA Macros – ทำงานอัตโนมัติของ Excel ด้วย Java
...
## คัดลอก Worksheet ไปยัง Workbook ปลายทาง – ส่วนหนึ่งของกระบวนการคัดลอก VBA Project
...
## คัดลอกโมดูล VBA จาก Template ไปยัง Workbook ปลายทาง – ย้ายโมดูล VBA
