...
{{< blocks/products/pf/tutorial-page-section >}}
## [Pivot‑Tabellen in Aspose.Cells für .NET – Pivot‑Tabelle erstellen](./net/pivot-tables/)
...
- [Vorlagen & Berichterstellung](./net/templates-reporting/)
- [Berechnungs‑Engine](./net/calculation-engine/)
- [OLE‑Objekte & eingebettete Inhalte](./net/ole-objects-embedded-content/)
...
- [Kommentare & Anmerkungen](./net/comments-annotations/)
- [Sicherheit & Schutz](./net/security-protection/)
- [Bilder & Formen](./net/images-shapes/)
- [Tabellen & strukturierte Verweise](./net/tables-structured-references/)
...
- [Excel‑Zwischensummen und Berechnung](./net/excel-subtotal-calculation/)
...
- [Konvertierung zu PDF](./net/conversion-to-pdf/)
...
- [Vorlagen & Berichterstellung](./java/templates-reporting/)
- [Berechnungs‑Engine](./java/calculation-engine/)
- [OLE‑Objekte & eingebettete Inhalte](./java/ole-objects-embedded-content/)
...
- [Kommentare & Anmerkungen](./java/comments-annotations/)
- [Sicherheit & Schutz](./java/security-protection/)
- [Bilder & Formen](./java/images-shapes/)
- [Tabellen & strukturierte Verweise](./java/tables-structured-references/)
