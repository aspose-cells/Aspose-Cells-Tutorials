...
**1. lépés: A Munkafüzet osztály importálása**
...
### Munkalapok elérése
**Áttekintés:** Célzott munkalap további műveletekhez.

**3. lépés: Munkafüzet-osztályok importálása**
```java
...
### Automatikus szűrő létrehozása (Excel-adatok szűrése)
**Áttekintés:** Alkalmazzon automatikus szűrőt, hogy szűkíthesse a sorokat a mentés előtt.

**5. lépés: Az AutoFilter osztály importálása**
```java
import com.aspose.cells.AutoFilter;
```

**6. lépés: A szűrőtartomány beállítása**
```java
...
### A munkafüzet mentése (Excel-munkafüzet mentése)
**Áttekintés:** Az összes módosítás mentése új fájlba.
