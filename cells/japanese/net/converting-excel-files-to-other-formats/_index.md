...
### [C# と Aspose.Cells を使用して Excel を PowerPoint として保存する方法](./how-to-save-excel-as-powerpoint-using-c-and-aspose-cells/)
Aspose.Cells for .NET を使い、C# で Excel ワークブックを PowerPoint プレゼンテーションに変換する手順を解説します。
