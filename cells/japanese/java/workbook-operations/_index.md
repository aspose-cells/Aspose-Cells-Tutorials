...
### [Java を使用して Excel にカスタム プロパティを追加する方法 – 完全ガイド](./how-to-add-custom-property-in-excel-using-java-complete-guid/)
Aspose.Cells for Java を使用して、Excel ファイルにカスタム プロパティを追加し、管理する方法を学びます。
