...
Используйте `importArray` метод для размещения данных массива, начиная с указанного индекса строки и столбца:
```java
...
4. **В: Поддерживаются ли нестроковые типы данных в массивах?**
