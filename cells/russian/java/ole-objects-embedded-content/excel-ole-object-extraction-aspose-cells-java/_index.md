...
- Лучшие практики по работе с различными форматами файлов, встроенными в Excel
...
Вы узнаете, как получать доступ к объектам OLE в рабочей книге и выполнять итерацию по ним, а также сохранять их в отдельных файлах в зависимости от типа формата.
...
**В2: Можно ли извлекать OLE-объекты более чем из одного рабочего листа одновременно?**
