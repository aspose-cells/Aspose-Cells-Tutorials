...
### Как защитить весь лист Excel?
 ...
 Вы можете защитить весь рабочий лист Excel с помощью Aspose.Cells для Java, вызвав`protect` метод на объекте рабочего листа с`ProtectionType.ALL` параметр.
