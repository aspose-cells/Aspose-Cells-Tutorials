...
## Предпосылки
Прежде чем погрузиться в тонкости защиты вашего рабочего листа, давайте убедимся, что у вас есть все необходимое для начала работы. Вот краткий контрольный список:
...
4. Образец файла Excel: Имейте готовый файл Excel, над которым вы хотите работать. Для нашего примера мы будем использовать `book1.xls`.
...
```
- Ограничение действий: первые несколько строк устанавливают разрешения для различных действий, таких как удаление строк/столбцов и редактирование содержимого.
