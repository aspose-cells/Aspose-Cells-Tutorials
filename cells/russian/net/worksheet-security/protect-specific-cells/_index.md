...
1. Visual Studio – Если вы еще этого не сделали, загрузите и установите Visual Studio. Это будет основная среда, в которой вы будете запускать свои .NET-приложения.
...
Да, Aspose.Cells позволяет вам блокировать целые строки или столбцы, изменяя `IsLocked` свойство для строк или столбцов, аналогично тому, как мы блокировали ячейки.
