...
Убедитесь, что в вашем проекте установлена библиотека Aspose.Cells. Если вы еще этого не сделали, вы можете [скачать библиотеку здесь](https://releases.aspose.com/cells/net/) и включите его в свое заявление.
...
Нам понадобится файл Excel с как минимум одной таблицей для демонстрации процесса преобразования. Вы можете создать простой файл Excel с именем `book1.xlsx` содержащий в себе таблицу.
## Импортные пакеты
