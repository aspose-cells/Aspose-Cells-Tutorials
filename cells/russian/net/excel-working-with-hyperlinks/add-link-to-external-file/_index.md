...
```
 Заменять`"Your Document Directory"` с фактическим путем, где вы хотите сохранить файлы. Это похоже на выбор правильной папки для хранения документов, что упрощает их последующий поиск!
...
Поскольку в вашей гиперссылке вы указали внешний файл, вам также необходимо создать этот файл, чтобы убедиться, что ссылка работает!
```csharp
