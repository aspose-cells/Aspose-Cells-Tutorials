...
### [Определить именованный диапазон в Excel с C# – создать книгу](./define-named-range-in-excel-with-c-create-workbook/)
Узнайте, как с помощью Aspose.Cells for .NET создать рабочую книгу и определить именованный диапазон в Excel на C#.
