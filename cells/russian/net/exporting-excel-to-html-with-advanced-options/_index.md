...
### [Как внедрить шрифты в HTML при экспорте Excel – Полное руководство](./how-to-embed-fonts-in-html-when-exporting-excel-complete-gui/)
Узнайте, как внедрять шрифты в HTML при экспорте Excel с помощью Aspose.Cells для .NET в полном пошаговом руководстве.
