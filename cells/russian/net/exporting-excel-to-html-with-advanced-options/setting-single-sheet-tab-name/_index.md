...
- ExportImagesAsBase64: встраивает изображения непосредственно в HTML в виде строк Base64, делая его самодостаточным.
...
Помните, возможности огромны. Этот урок лишь поверхностно. Не бойтесь исследовать все возможности, которые предлагает Aspose.Cells!
...
Для получения подробной документации посетите [Документация Aspose.Cells](https://reference.aspose.com/cells/net/).
