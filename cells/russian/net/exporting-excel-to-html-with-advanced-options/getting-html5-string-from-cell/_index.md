...
1. Визуальная Студия: Убедитесь, что на вашем компьютере установлена рабочая копия Visual Studio. Вы можете загрузить ее с[Visual Studio](https://visualstudio.microsoft.com/).
