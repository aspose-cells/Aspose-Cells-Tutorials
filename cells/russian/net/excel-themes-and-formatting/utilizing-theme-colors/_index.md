...
Применяем тему Accent4 к тексту в ячейке. `0.1` value придает ему едва уловимый оттенок, который может добавить дополнительную изюминку вашим электронным таблицам.
