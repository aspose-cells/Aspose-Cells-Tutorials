...
### [Создание рабочей книги Excel – пошаговое руководство по добавлению таблиц и правил именования](./create-excel-workbook-step-by-step-guide-to-adding-tables-an/)
Узнайте, как создать рабочую книгу Excel, добавить таблицы и задать правила именования с помощью Aspose.Cells для .NET.
