...
### [Сохранить книгу Excel и добавить именованный диапазон – Полное руководство C#](./save-excel-workbook-and-add-named-range-full-c-guide/)
Полное руководство по сохранению книги Excel и добавлению именованного диапазона с использованием Aspose.Cells для .NET на C#.
