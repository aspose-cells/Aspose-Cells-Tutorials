...
### Какова цель `GlobalizationSettings` класс в Aspose.Cells для .NET?
...
### Могу ли я использовать `RussianGlobalization` класс с другими функциями Aspose.Cells для .NET?
...
### Как я могу продлить `RussianGlobalization` класс для поддержки большего количества значений ошибок и логических значений?
...
### Можно ли использовать `RussianGlobalization` класс с другими продуктами Aspose?
Да, `GlobalizationSettings` класс является общей функцией в различных продуктах Aspose, включая Aspose.Cells для .NET, Aspose.Cells для .NET и Aspose.PDF для .NET. Вы можете создать аналогичный пользовательский класс настроек глобализации и использовать его с другими продуктами Aspose, чтобы обеспечить единообразный языковой опыт в ваших приложениях.
