...
Сначала вам нужно загрузить вашу рабочую книгу. Это файл, содержащий вычисления, которые вы, возможно, захотите прервать. Вот как это сделать:
```csharp
// Исходный каталог
...
### Можно ли вычислять формулы условно с помощью Aspose.Cells?
