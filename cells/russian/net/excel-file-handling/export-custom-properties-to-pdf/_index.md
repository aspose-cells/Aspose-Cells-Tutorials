...
Прежде чем начать кодирование, вам нужно определить ваши входные и выходные каталоги. Это то место, где вы будете читать файл Excel и где будет сохранен сгенерированный PDF.
```csharp
// Входной каталог
...
Конечно! `PdfSaveOptions` Класс предоставляет различные свойства, которые позволяют детально настраивать вывод PDF-файла.
