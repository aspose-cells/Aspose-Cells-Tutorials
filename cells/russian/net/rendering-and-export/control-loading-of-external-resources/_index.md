...
```
 Эта линия соединяет ваш`Workbook` пример с`MyStreamProvider` класс, который вы создали ранее. Это означает, что всякий раз, когда внешние ресурсы встречаются во время преобразования, ваш поставщик будет обрабатывать их, как указано.
