...
```
Эти пространства имен предоставят вам доступ к классам Workbook, Worksheet, ImageOrPrintOptions и SheetRender, которые жизненно важны для нашей задачи.
