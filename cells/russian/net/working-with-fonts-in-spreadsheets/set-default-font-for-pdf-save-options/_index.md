...
Теперь давайте отрендерим первый лист книги как изображение PNG. Мы будем использовать `SheetRender` класс, чтобы достичь этого.
```csharp
