...
### [Изменение размера шрифта в текстовом поле в Excel с C# – Полное руководство](./change-textbox-font-size-in-excel-with-c-complete-guide/)
Узнайте, как изменить размер шрифта в текстовом поле Excel с помощью Aspose.Cells для .NET и C#. Пошаговое руководство.
