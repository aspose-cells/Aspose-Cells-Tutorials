---
"description": "Узнайте, как задать шрифты Дальнего Востока и латиницы в Excel с помощью Aspose.Cells для .NET в этом подробном и простом руководстве."
...
Теперь, когда у нас есть настроенный каталог, давайте создадим новую рабочую книгу, куда мы добавим наш контент. Это похоже на начало работы с чистым холстом перед покраской.
```csharp
