...
```
Этот шаг получает первый рабочий лист рабочей книги и назначает его `ws` переменная. Если ваш слайсер находится на другом листе, просто отрегулируйте индекс соответствующим образом.
