...
Загрузите пример файла Excel для использования в этом руководстве. Вы можете создать его самостоятельно или взять пример файла из любой точки мира в Интернете. Убедитесь, что он содержит несколько срезов для практики.
### 4. Базовые знания C#
...
using System.Text;
```
Теперь, когда у нас есть все необходимые условия и ссылки на пакеты, давайте отформатируем эти слайсеры шаг за шагом!
...
Пришло время загрузить ваш пример рабочей книги, содержащей слайсеры. Вот как это можно сделать:
```csharp
...
```
Объяснение: Срезы хранятся как коллекция на рабочем листе. Указав `[0]`мы берем первый доступный слайсер. Это как смотреть на первый кусочек пазла среди многих — давайте работать с этим!
...
Давайте заставим этот слайсер сиять, установив его стиль!
```csharp
...
Практикуясь, подумайте о том, как эти параметры форматирования могут повлиять на презентации, которые вы создаете, или на идеи, которые вы получаете из своих данных. Продолжайте экспериментировать, и вы обнаружите, что ваши рабочие тетради выглядят профессионально в кратчайшие сроки!
