...
```
Эта строка инициализирует рабочую книгу с использованием потока файлов. Объект рабочей книги теперь представляет ваш файл Excel и позволяет вам манипулировать его содержимым.
...
```csharp
// Удаление листа с использованием его индекса
...
Нет, как только лист удаляется, он навсегда удаляется из этого экземпляра книги. Сохраните резервную копию, если вы не уверены.
