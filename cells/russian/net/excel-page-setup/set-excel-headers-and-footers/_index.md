...
Отлично! Теперь, когда ваша среда настроена и пакеты импортированы, давайте разберем процесс настройки верхних и нижних колонтитулов в Excel пошагово.
...
Пояснение: Здесь замените `YOUR DOCUMENT DIRECTORY` фактическим путем, по которому вы хотите сохранить файл Excel. `Workbook` объект — это ваша основная точка входа для создания и управления файлами Excel.
