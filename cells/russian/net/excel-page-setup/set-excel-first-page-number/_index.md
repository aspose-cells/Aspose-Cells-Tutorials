...
После того, как вы выполнили все необходимые условия, давайте импортируем необходимые пакеты. В этом случае мы в первую очередь сосредоточимся на `Aspose.Cells` пространство имен. Вот как начать:
...
После настройки проекта давайте рассмотрим процесс установки номера первой страницы для первого рабочего листа в файле Excel.
