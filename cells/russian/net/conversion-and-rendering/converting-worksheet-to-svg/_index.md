...
Здесь, `"Template.xlsx"` — имя файла Excel, с которым вы работаете. Убедитесь, что этот файл существует в указанном каталоге, в противном случае вы столкнетесь с ошибками.

## Шаг 3: Задайте параметры изображения или печати для преобразования в SVG
...
## Шаг 5: Создайте `SheetRender` Объект для рендеринга
...
The `SheetRender` Объект принимает два аргумента: конвертируемый рабочий лист и параметры изображения, которые вы определили ранее.
