...
```
В этой строке мы создаем новый экземпляр `Workbook` class и загрузите существующий файл Excel. Убедитесь, что имя файла совпадает с тем, что у вас в исходном каталоге.
...
```
Эта простая строка кода подтверждает, что ваша программа завершила выполнение без каких-либо задержек.
## Заключение
