...
```
 ...
 Мы создаем экземпляр`Workbook` класс и передаем путь к нашему файлу Excel с именем`EmbeddedMolSample.xlsx`. Этот шаг инициализирует рабочую книгу, позволяя вам получить доступ к ее содержимому.
