...
Теперь мы определяем диапазон ячеек, которые мы хотим напечатать. Здесь, допустим, мы хотим напечатать от ячейки A1 до T35. Этот диапазон охватывает все данные, которые мы хотим включить в распечатку.
```csharp
