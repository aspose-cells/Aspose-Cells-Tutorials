...
Теперь, когда у нас все готово, давайте начнем с разбиения преобразования текста в столбцы на несколько простых в выполнении шагов.
...
Далее давайте создадим нашу рабочую книгу. Это по сути файл, в котором будут обрабатываться все ваши данные.
```csharp
