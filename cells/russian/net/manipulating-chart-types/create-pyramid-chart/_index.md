...
```
 ...
 В этой строке мы указываем тип диаграммы как`Pyramid` и определите его положение на рабочем листе с помощью индексов строк и столбцов. Это похоже на размещение картины на стене — вам нужно выбрать, где она будет выглядеть лучше всего!
