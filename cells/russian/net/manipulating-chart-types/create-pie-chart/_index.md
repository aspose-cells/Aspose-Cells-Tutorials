...
Для начала импортируйте необходимые пространства имен и пакеты, необходимые для этого руководства. Они включают в себя базовые операции ввода-вывода и пакет Aspose.Cells.
...
Добавление меток непосредственно к сегментам диаграммы может облегчить понимание. Давайте включим названия регионов и значения продаж в срезы круговой диаграммы.
