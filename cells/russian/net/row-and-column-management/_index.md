...
### [Как удалить строки в Excel с C# – защитить заголовок таблицы](./how-to-delete-rows-in-excel-with-c-protect-table-header/)
Узнайте, как удалить строки в Excel с помощью C#, сохранив заголовок таблицы.
