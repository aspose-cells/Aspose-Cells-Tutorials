...
Когда поток файлов готов, пришло время вызвать основного проигрывателя: `Workbook` класс из Aspose.Cells. Этот объект представляет наш файл Excel, позволяя нам выполнять любые изменения строк или столбцов.
```csharp
