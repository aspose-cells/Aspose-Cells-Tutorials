...
using Aspose.Cells;
```
Эти пространства имен позволят вам работать с классами Workbook и Worksheet и обрабатывать файловые операции. Теперь давайте разберем шаги для вставки нескольких строк в файл Excel.
