...
```
Эта строка инициализирует новую рабочую книгу с одним листом по умолчанию, которым вы можете управлять.
...
```
 В этом коде мы включаем градиентную заливку и указываем два цвета: белый и восхитительный синий.**Tip:** Вы можете изменить эти цвета в соответствии со своим брендом или эстетическими предпочтениями!
