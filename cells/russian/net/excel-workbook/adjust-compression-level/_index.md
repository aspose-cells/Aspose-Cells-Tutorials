...
В этой строке подготавливаются параметры, которые мы будем использовать для сохранения нашей рабочей книги в формате XLSB.
