...
Оператор тильда (~) означает, что мы хотим исключить определенные имена из процесса загрузки. Это важно, если вы хотите сохранить легкую рабочую нагрузку и избежать ненужных данных, которые могут усложнить вашу обработку.
...
В этой строке вы создаете новый экземпляр `Workbook` класс, передавая путь к вашему образцу файла Excel и параметры загрузки. Это загружает вашу рабочую книгу с определенными именами, отфильтрованными, как указано.
