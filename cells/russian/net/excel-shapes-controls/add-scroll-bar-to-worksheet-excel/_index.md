---
title: Добавить полосу прокрутки на рабочий лист в Excel
linktitle: Добавить полосу прокрутки на рабочий лист в Excel
...
Теперь, когда мы выполнили все необходимые предварительные условия, давайте перейдем к импорту необходимых пакетов и написанию кода для добавления полосы прокрутки.
## Импортные пакеты
