...
- Visual Studio: Мы предполагаем, что у вас есть рабочая среда, настроенная с Visual Studio. Если нет, вы можете легко загрузить ее с [Визуальная Студия](https://visualstudio.microsoft.com/vs/).
