...
3. Базовое понимание C#: вы должны быть знакомы с основными концепциями кодирования на C#.
...
Зачем останавливаться на чем-то одном? На этом этапе мы добавим еще одну овальную форму, на этот раз создав идеальный круг, сделав высоту и ширину одинаковыми.
...
### Можно ли изменить цвет контура овала?
