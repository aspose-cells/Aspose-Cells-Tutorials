...
## Предпосылки
Прежде чем мы засучим рукава и начнем кодировать, давайте убедимся, что у вас все необходимое организовано. Вот предварительные условия, которые вы должны были вычеркнуть из своего списка:
1. Visual Studio: вам понадобится установить эту IDE для написания и запуска кода C#.
...
list.Add(p2);
```
Это гарантирует, что теперь в нашем списке содержатся все необходимые данные.
...
Не стесняйтесь получить доступ к [Форум поддержки Aspose](https://forum.aspose.com/c/cells/9) по любым вопросам.
