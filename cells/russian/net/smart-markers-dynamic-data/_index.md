...
### [Как повторять листы — Полное руководство по автоматизации Excel](./how-to-repeat-worksheets-complete-guide-for-excel-automation/)
Узнайте, как автоматически дублировать листы в Excel с помощью Aspose.Cells, ускоряя процесс создания отчетов и шаблонов.

### [Руководство по Master‑Detail в Excel – заполнение шаблонов с помощью Smart Markers](./master-detail-excel-guide-populate-templates-with-smart-mark/)
Узнайте, как создавать книги Master‑Detail, заполняя шаблоны Excel с помощью Smart Markers в Aspose.Cells for .NET.

### [Создание книги Master‑Detail с помощью Aspose.Cells Smart Marker](./create-master-detail-workbook-with-aspose-cells-smart-marker/)
Узнайте, как создать книгу с мастер‑деталь связью, используя Smart Marker в Aspose.Cells для .NET.
