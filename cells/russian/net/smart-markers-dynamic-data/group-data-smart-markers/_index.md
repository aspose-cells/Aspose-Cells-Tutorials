...
При активном подключении вам нужно создать команду для выполнения SQL-запроса. Эта команда определит, какие данные вы хотите получить из вашей базы данных.
```csharp
...
## Шаг 7: Создайте объект DataTable
...
Теперь, когда мы создали нашу рабочую книгу и расставили смарт-маркеры, мы можем установить источник данных для DataTable, созданного нами ранее:
```csharp
