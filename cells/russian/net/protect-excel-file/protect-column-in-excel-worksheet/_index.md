...
2.  Библиотека Aspose.Cells: Вам понадобится библиотека Aspose.Cells for .NET. Если вы ее еще не установили, вы можете получить ее из[Страница загрузки Aspose.Cells](https://releases.aspose.com/cells/net/).
...
Далее нам нужно подготовить стили, которые мы будем применять к ячейкам.
