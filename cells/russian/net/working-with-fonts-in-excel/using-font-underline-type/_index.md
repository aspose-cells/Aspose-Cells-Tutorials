...
```
Эта строка инициализирует новую рабочую книгу. Думайте об этом как об открытии чистого холста, на котором вы можете начать создавать свой шедевр.
...
```
На этом этапе «Hello Aspose!» — это содержимое вашей ячейки A1. Просто, не правда ли?
