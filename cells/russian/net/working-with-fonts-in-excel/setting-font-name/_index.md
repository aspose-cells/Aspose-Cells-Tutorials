...
using Aspose.Cells;
```
Это позволяет получить доступ ко всем классам и методам библиотеки Aspose.Cells, которые будут необходимы для наших задач по обработке данных Excel.
Теперь, когда у нас все готово, давайте разберем процесс задания имени шрифта в файле Excel на простые шаги.
...
```
 Подумайте о`Workbook` объект как чистый холст, на который вы будете добавлять свои данные и форматирование.
...
### Можно ли использовать Aspose.Cells бесплатно?  
 Aspose.Cells — коммерческий продукт, но вы можете начать с[бесплатная пробная версия](https://releases.aspose.com/) оценить его особенности.
