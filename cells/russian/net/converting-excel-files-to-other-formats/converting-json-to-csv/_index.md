...
Теперь, когда у нас есть пустая рабочая книга, нам нужно получить доступ к ее ячейкам. `Cells` Коллекция в Aspose.Cells представляет все ячейки на листе, куда вы будете помещать данные JSON.
```csharp
// Получить клетки
