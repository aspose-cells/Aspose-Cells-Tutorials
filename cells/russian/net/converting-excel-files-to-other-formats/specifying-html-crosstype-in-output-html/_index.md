...
```csharp
opts.HtmlCrossStringType = HtmlCrossType.MSExpилиt;
// или 
...
После настройки параметров пришло время сохранить преобразованный HTML-файл. Используйте `Save` метод на вашем `Workbook` объект:
```csharp
// Выходной HTML-код
