...
Объект Workbook — это место, где происходит большинство действий. Когда вы создаете `Workbook` Например, вы по сути «разблокируете» свой файл Excel для того, чтобы Aspose.Cells мог вносить в него изменения.
```csharp
