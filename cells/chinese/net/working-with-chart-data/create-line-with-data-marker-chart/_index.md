...
description: 了解如何使用 Aspose.Cells for .NET 在 Excel 中创建带数据标记的线条图。按照此分步指南轻松生成和自定义图表。
weight: 10
...
是的，需要许可证才能使用完整功能。您可以获得[临时执照](https://purchase.aspose.com/temporary-license/)或者从[免费试用](https://releases.aspose.com/).
