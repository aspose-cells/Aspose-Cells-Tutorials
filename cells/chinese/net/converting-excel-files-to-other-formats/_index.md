...
### [使用 C# 和 Aspose.Cells 将 Excel 保存为 PowerPoint](./how-to-save-excel-as-powerpoint-using-c-and-aspose-cells/)
本教程演示如何使用 C# 和 Aspose.Cells 将 Excel 工作簿保存为 PowerPoint 演示文稿，帮助您快速生成演示文件。
