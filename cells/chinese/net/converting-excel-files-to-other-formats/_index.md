...
### [在 .NET 中以编程方式将 Excel 导出为 PowerPoint（带可编辑图表）](./export-excel-to-powerpoint-with-editable-charts-in-c/)
本教程展示如何使用 Aspose.Cells for .NET 将 Excel 工作表导出为 PowerPoint，并保留可编辑的图表，以便在演示文稿中进行进一步修改。
