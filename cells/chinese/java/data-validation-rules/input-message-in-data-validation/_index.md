---
title: 在数据验证中输入信息
linktitle: 在数据验证中输入信息
second_title: Aspose.Cells Java Excel 处理 API
description: 了解如何使用 Aspose.Cells for Java 增强 Excel 中的数据验证。带有代码示例的分步指南可提高数据准确性和用户指导。
weight: 18
...
要将数据验证添加到多个单元格，您可以定义单元格范围并将验证规则应用于该范围。 Aspose.Cells for Java 允许您使用`CellArea`班级。
