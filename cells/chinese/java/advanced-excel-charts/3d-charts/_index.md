...
description: 学习使用 Aspose.Cells 在 Java 中创建令人惊叹的 3D 图表。Excel 数据可视化的分步指南。
weight: 13
...
要向三维图表添加多个数据系列，可以使用`chart.getNSeries().add()`方法并指定每个系列的数据范围。确保为每个系列设置适当的图表类型以区分它们。
...
您可以在以下网站找到有关 Aspose.Cells for Java 的全面文档和资源：[Aspose.Cells for Java 文档](https://reference.aspose.com/cells/java/).
{{< /blocks/products/pf/tutorial-page-section >}}
