---
title: Manipulating Z-Order of Shapes in Excel using Aspose.Cells
weight: 7700
limit: 
description: Learn how to load an Excel workbook, modify shape Z-orders, and save changes using Aspose.Cells for .NET.
...
2. Install Aspose.Cells for .NET via NuGet Package Manager. Use the following command in the Package Manager Console:  
   ```
   Install-Package Aspose.Cells
   ```
3. Add a reference to the Aspose.Cells namespace in your project:  
   ```csharp
   using Aspose.Cells;
   using Aspose.Cells.Drawing; 
   ```
4. Prepare your source Excel file and update the `sourceDir` and `outputDir` paths in the code examples provided.  
5. Copy and paste the provided code snippet into your project to manipulate the Z-order of shapes within your Excel file.  
6. Build and run your application to see the changes reflected in the output Excel file.
