...
language: en
lastmod: 2026-09-21
og_description: Configure SmartMarkerOptions ArrayAsSingle in C# to export JSON arrays
  as a single cell value. Learn the complete step‑by‑step solution.
og_image_alt: Screenshot of an Excel sheet showing a JSON array stored in a single
  cell after using SmartMarkerOptions
og_title: Configure SmartMarkerOptions ArrayAsSingle in C# – full guide
schemas:
- author: Aspose
...
- C#
- Excel automation
title: Configure SmartMarkerOptions ArrayAsSingle in C# for JSON arrays
url: /net/smart-markers-dynamic-data/configure-smartmarkeroptions-arrayassingle-in-c-for-json-arr/
---
...
> **Prerequisites** – You need the Aspose.Cells for .NET library (v23.12 or later) and a .NET development environment (Visual Studio 2022 recommended). Basic knowledge of C# and DataTables is assumed.
