---
title: Apply Colors & Backgrounds in Excel using Aspose.Cells for .NET
weight: 7700
limit: 
description: Learn how to apply colors and background styles in Excel using Aspose.Cells for .NET. Customize cell formatting and save workbooks in Excel 97-2003 format.
...
1. Download and Install Aspose.Cells for .NET  
   - Download the latest version from [Aspose.Cells Download](https://releases.aspose.com/cells/net/).  
...
3. Apply Colors and Backgrounds to Excel Cells  
   - Create a new `Workbook` object.  
   - Retrieve the `Worksheet` and apply custom styles to specific cells.  
   - Save the modified workbook in `.xls` format.  
