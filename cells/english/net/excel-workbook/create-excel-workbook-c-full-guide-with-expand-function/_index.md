...
language: en
og_description: Create Excel workbook C# with a clear example and discover how to
  use expand function in Excel to generate dynamic arrays.
og_title: Create Excel Workbook C# – Complete Programming Guide
schemas:
- author: Aspose
...
- aspose-cells
- .net
title: Create Excel Workbook C# – Full Guide with Expand Function
url: /net/excel-workbook/create-excel-workbook-c-full-guide-with-expand-function/
---
...
# Create Excel Workbook C# – Full Guide with Expand Function
