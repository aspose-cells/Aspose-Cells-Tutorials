...
category: general
date: 2026-08-04
description: Create excel workbook java and parse Japanese era dates, then save workbook
  as xlsx using Aspose.Cells for Java.
draft: false
images:
...
language: en
lastmod: 2026-08-04
og_description: Create excel workbook java and automatically convert Japanese era
  dates to Gregorian, then save workbook as xlsx with Aspose.Cells.
og_image_alt: Java code creating an Excel workbook and converting a Japanese era date
  to Gregorian
og_title: Create excel workbook java – Japanese date conversion guide
schemas:
- author: Aspose
...
- date conversion
- xlsx
title: 'Create excel workbook java: handle Japanese era dates'
url: /java/workbook-operations/create-excel-workbook-java-handle-japanese-era-dates/
---
...
# Create excel workbook java: handle Japanese era dates
