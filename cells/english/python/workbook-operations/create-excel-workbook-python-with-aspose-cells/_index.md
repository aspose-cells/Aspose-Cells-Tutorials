...
description: Create Excel workbook python using Aspose.Cells. Learn how to populate
  worksheet with data, use lambda function excel, and calculate column sums in a few
  steps.
draft: false
keywords:
...
og_description: Create Excel workbook python with Aspose.Cells. This guide shows how
  to populate worksheet with data, use lambda function excel, and calculate column
  sums.
og_title: Create Excel Workbook Python with Aspose.Cells
schemas:
- author: Aspose
...
- Aspose.Cells
- Excel Automation
title: Create Excel Workbook Python with Aspose.Cells
url: /python/workbook-operations/create-excel-workbook-python-with-aspose-cells/
---
...
# Create Excel Workbook Python with Aspose.Cells
...
- Basic familiarity with Python loops (nothing fancy)  
