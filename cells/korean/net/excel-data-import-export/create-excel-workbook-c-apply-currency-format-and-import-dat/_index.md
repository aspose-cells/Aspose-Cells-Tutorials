...
category: general
date: 2026-03-30
description: C#로 통화 서식이 적용된 Excel 워크북 만들기. DataTable을 가져오고, Excel에 숫자 서식을 추가하고, 몇
  분 안에 통화 서식 열을 적용하는 방법을 배워보세요.
draft: false
keywords:
...
language: ko
og_description: C#로 Excel 워크북을 만들고 셀을 즉시 통화 형식으로 지정하세요. 이 단계별 튜토리얼에서는 DataTable을 Excel로
  가져오고 열에 숫자 형식을 추가하는 방법을 보여줍니다.
og_title: C#로 Excel 워크북 만들기 – 통화 서식 가이드
tags:
- Aspose.Cells
- C#
- Excel automation
title: C#로 Excel 워크북 만들기 – 통화 형식 적용 및 DataTable 가져오기
url: /ko/net/excel-data-import-export/create-excel-workbook-c-apply-currency-format-and-import-dat/
---
...
# Excel 워크북 만들기 C# – 통화 형식 적용 및 DataTable 가져오기
