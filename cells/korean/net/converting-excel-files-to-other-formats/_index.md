...
### [.NET에서 Excel 파일을 PowerPoint로 내보내기 – 전체 프로그래밍 가이드](./export-excel-to-powerpoint-with-aspose-cells-complete-progra/)
Aspose.Cells for .NET을 사용해 Excel 데이터를 PowerPoint 프레젠테이션으로 변환하는 전체 단계별 가이드를 제공합니다.
