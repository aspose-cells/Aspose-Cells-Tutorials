...
category: general
date: 2026-03-25
description: C#를 사용하여 docx를 빠르게 xps로 변환하세요. Word를 xps로 내보내는 방법, 코드에서 docx를 로드하는 방법,
  그리고 Aspose.Words를 사용해 문서를 xps로 저장하는 방법을 배워보세요.
draft: false
keywords:
- convert docx to xps
- export word to xps
...
language: ko
og_description: C#로 docx를 빠르게 XPS로 변환하세요. 이 튜토리얼에서는 Word를 XPS로 내보내고, 코드에서 docx를 로드하며,
  문서를 XPS로 저장하는 과정을 안내합니다.
og_title: C#에서 docx를 xps로 변환하기 – 완전 가이드
tags:
- csharp
- aspose-words
- document-conversion
title: C#에서 docx를 xps로 변환하기 – 완전 가이드
url: /ko/net/xps-and-pdf-operations/convert-docx-to-xps-in-c-complete-guide/
---
...
![Aspose.Words를 사용한 docx를 xps로 변환 – 코드와 출력 화면](/images/convert-docx-to-xps.png)
