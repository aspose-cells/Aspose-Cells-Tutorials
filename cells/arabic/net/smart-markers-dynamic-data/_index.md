...
### [تهيئة SmartMarkerOptions الخاصية ArrayAsSingle في C# لمصفوفات JSON](./configure-smartmarkeroptions-arrayassingle-in-c-for-json-arr/)
تعلم كيفية تهيئة خاصية ArrayAsSingle في SmartMarkerOptions لمعالجة مصفوفات JSON في C#.
