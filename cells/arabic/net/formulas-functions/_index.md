...
### [كيفية استخدام SEQUENCE في C# – إنشاء مصنف Excel](./how-to-use-sequence-in-c-create-excel-workbook/)
تعلم كيفية استخدام دالة SEQUENCE في C# لإنشاء مصنف Excel وتوليد القيم تلقائيًا.
