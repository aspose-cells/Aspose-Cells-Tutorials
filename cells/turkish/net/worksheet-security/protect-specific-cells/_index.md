---
title: Aspose.Cells kullanarak Çalışma Sayfasındaki Belirli Hücreleri Koruyun
linktitle: Aspose.Cells kullanarak Çalışma Sayfasındaki Belirli Hücreleri Koruyun
...
# Aspose.Cells kullanarak Çalışma Sayfasındaki Belirli Hücreleri Koruyun
...
```
 Bu kod bloğunda, tüm sütunlarda (255'e kadar) yineleme yapıyoruz ve`IsLocked` mülk`false` Bu, esasen bu sütunlardaki tüm hücrelerin kilidini açar ve bunları varsayılan olarak düzenlenebilir hale getirir. Daha sonra stili, sütuna uygularız`ApplyStyle()` yöntem.
