...
Varsayılan olarak, bir Excel çalışma sayfasındaki tüm hücreler kilitlidir. Ancak, bir çalışma sayfasını koruduğunuzda, kilitli durum zorunlu hale getirilir. Yalnızca belirli satırların veya hücrelerin korunduğundan emin olmak için önce tüm sütunların kilidini açabilirsiniz. Yalnızca belirli satırları korumak istiyorsanız bu adım önemlidir.
```csharp
