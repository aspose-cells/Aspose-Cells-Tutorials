...
Bu adımda, şunu kullanarak yeni bir Excel çalışma kitabı oluşturursunuz: `Aspose.Cells.Workbook` sınıf. Bu, çalışma sayfanız ve şekilleriniz için bir kap görevi görecektir.
```csharp
