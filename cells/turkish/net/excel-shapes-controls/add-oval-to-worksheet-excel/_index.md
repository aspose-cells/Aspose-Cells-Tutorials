...
- İlk iki sayı ovalin sol üst köşesinin satırını ve sütununu temsil eder.
...
```
Bu, ovalin çalışma sayfası içerisinde serbestçe hareket etmesini sağlar ve çizgi kalınlığı ve stili görsel tutarlılık için ayarlanır.
