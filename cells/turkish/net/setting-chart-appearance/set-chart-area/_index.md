...
3. Kullanım Yönergeleri Ekleyin: Kod dosyanızın en üstüne şu kullanım yönergelerini ekleyin:
...
Şimdi, belirli hücrelere bazı değerler ekleyeceğiz. İşte çalışma sayfası hücrelerine veri girişinin nasıl yapılacağı:
...
Burada, 5. satırdan, 0. sütundan başlayıp sırasıyla 25. ve 10. satırlara kadar uzanan bir sütun grafiği ekledik. Göz kamaştırmaya hazır!
