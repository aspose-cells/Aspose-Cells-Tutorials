...
1. Visual Studio: C# kodunuzu yazıp çalıştırabilmeniz için bu IDE'nin yüklü olması gerekir.
...
Şimdi, kendi `Individual` örnekler, bir ilişki kurduğunuzdan emin olun `Wife` her biriyle.
```csharp
...
```
Parametre şu şekilde ayarlandı: `false` veri kaynağı uygulandıktan sonra herhangi bir hücre formülünü işlemek istemediğimizi belirtir.
