...
3. Visual Studio veya herhangi bir IDE: Kodunuzu burada yazıp test edeceksiniz. 
...
Daha önce oluşturduğumuz veri setini çalışma kitabı tasarımcısına bağlayalım ki veriler akıllı işaretçiler üzerinden düzgün bir şekilde akabilsin.
```csharp
// Çalışma Kitabını Belirleyin
designer.Workbook = workbook;
// Boş dizeyi null olarak işlemek için bu bayrağı kullanın. Yanlışsa, ISBLANK çalışmayacaktır.
...
Akıllı işaretleyiciler, Excel raporları oluştururken veri kaynaklarından alınan değerlerle değiştirilebilen şablonlardaki yer tutuculardır.
