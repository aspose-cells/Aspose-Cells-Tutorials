...
```
Kullanımı `SetDataSource` yönteminde, veri setimizi tasarımcıya bağlarız. Bu, şablonumuzdaki akıllı işaretçilerin, sağladığınız veri setine göre dinamik olarak veri çekmesini sağlar. Veri seti, bir veritabanı sorgusundan bir DataTable, bir dizi veya bir liste gibi herhangi bir veri yapısı olabilir.
