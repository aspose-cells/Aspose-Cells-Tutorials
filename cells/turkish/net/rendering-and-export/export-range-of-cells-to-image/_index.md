...
3. Temel C# Bilgisi: C# ve .NET framework'e aşinalık, kodu daha iyi anlamanıza yardımcı olacaktır.
...
```csharp
// Kaynak dosyadan çalışma kitabı oluşturun.
...
```
Bu adım, özellikle kodu bir konsol uygulamasında çalıştırdığınızda, işlemin başarısını doğrulamak için kritik öneme sahiptir.
## Çözüm
