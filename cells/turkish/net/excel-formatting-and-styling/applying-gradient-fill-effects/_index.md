...
```
Bu satır, sizin düzenlemeniz için varsayılan bir çalışma sayfası içeren yeni bir çalışma kitabı başlatır.
...
```
 Bu kodda degrade dolguyu açıyoruz ve iki renk belirliyoruz: beyaz ve hoş bir mavi.**Tip:** Markanıza veya estetik tercihlerinize uyacak şekilde bu renkleri değiştirebilirsiniz!
