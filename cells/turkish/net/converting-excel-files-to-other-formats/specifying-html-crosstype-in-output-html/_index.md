...
- .NET için Aspose.Cells: Projenizde Aspose.Cells kütüphanesinin yüklü olduğundan emin olun. Bunu şuradan indirebilirsiniz: [Aspose web sitesi](https://releases.aspose.com/cells/net/).
...
```csharp
opts.HtmlCrossStringType = HtmlCrossType.MSExpveyat;
// veya 
...
### .NET projeme Aspose.Cells'i nasıl yüklerim?  
