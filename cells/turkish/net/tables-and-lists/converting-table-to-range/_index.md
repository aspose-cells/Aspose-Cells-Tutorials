...
Kodlama örneklerimizde C# kullanacağımız için C# gibi .NET dillerine ilişkin temel bir anlayışa sahip olmanız gerekir.
...
```
 Yer değiştirmek`"Your Document Directory"` Excel dosyanızın bulunduğu gerçek yol ile (`book1.xlsx`) yer almaktadır. Bu, belgenize erişimin temeli olacaktır.
