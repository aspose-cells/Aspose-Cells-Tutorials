...
Son olarak, bu yorumları unutmayın! Bunlar, önemli notları veya hatırlatıcıları takip etmenize yardımcı olan masalarınız için yapışkan notlar gibidir. [Excel'de Tablo veya Listenin Yorumunu Ayarlama](./setting-comment-of-table-or-list/) Verilerinize nasıl açıklama ekleyeceğinizi ve elektronik tablolarınıza başka bir organizasyon katmanı nasıl ekleyeceğinizi göstereceğiz. 
