...
İşte sihir burada gerçekleşiyor! Dondurulmuş bölmeleri ayarlamak için şunu kullanın: `FreezePanes` dondurma işleminin başlamasını istediğiniz satır ve sütunu ve kaç satır ve sütunun dondurulacağını belirten yöntem.
```csharp
...
```
Orijinal dosyayı da korumak istiyorsanız, dosyayı farklı bir adla kaydettiğinizden emin olun.
...
### Dondurma bölmelerini uyguladıktan sonra ayarlarını değiştirebilir miyim?
