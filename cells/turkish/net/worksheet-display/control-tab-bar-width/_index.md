---
"description": "Aspose.Cells for .NET kullanarak Excel çalışma sayfalarında sekme çubuğu genişliğini nasıl kontrol edeceğinizi öğrenin—yararlı örneklerle dolu adım adım kılavuz."
...
```
Değer `800` sadece bir örnek. Düzeniniz için en iyi neyin işe yaradığını görmek için bununla oynayın!
...
### Eğer ayarlarsam ne olur? `ShowTabs` yanlış mı?
