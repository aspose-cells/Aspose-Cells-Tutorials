...
## Paketleri İçe Aktar
İlk önce, projemizin Aspose.Cells kütüphanesini tanıdığından emin olmamız gerekiyor. Gerekli ad alanlarını içe aktaralım. C# dosyanızın en üstüne aşağıdaki satırları ekleyin:
```csharp
using System.IO;
using Aspose.Cells;
```
