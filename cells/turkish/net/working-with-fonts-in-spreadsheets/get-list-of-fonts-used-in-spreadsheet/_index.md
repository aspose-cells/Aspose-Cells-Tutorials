...
```
Bu döngü, her yazı tipinde çalışır `fnts` dizi, bunları tek tek konsola çıktı olarak verir. Excel dosyanızdaki tüm harika tipografi seçimlerini göstermek gibidir!
## Çözüm
