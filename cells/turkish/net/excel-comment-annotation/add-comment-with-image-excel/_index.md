...
Kütüphaneyi yükledikten sonra kodunuzu yazmaya başlayabilirsiniz. İşte adım adım nasıl yapacağınız.
...
```csharp
// Yorumla ilişkili şekle görüntü verilerini ayarlayın
...
Aspose.Cells PNG, JPEG ve BMP gibi çeşitli resim formatlarını destekler.
