...
1. Aspose.Cells for .NET: İndirin [.NET için Aspose.Cells](https://releases.aspose.com/cells/net/) Kütüphane. Excel dosyalarıyla programlı olarak çalışmak için kapsamlı bir API sağlar.
...
```
Bu adımda:
- çalışma kitabı.Çalışma Sayfaları[indeks]: Çalışma sayfasını dizinini kullanarak alır.
...
Kullanmak `worksheet.Name = "New Name";` Her çalışma sayfasına özel bir isim vermek.
