...
Excel dosyasıyla çalışmak için bir `FileStream`Bu, dosyayı Aspose.Cells'in içeriğini okumasına ve düzenlemesine izin verecek şekilde açar.
```csharp
...
Hayır, Aspose.Cells bağımsız bir kütüphanedir, dolayısıyla bilgisayarınıza Excel'in kurulu olmasına gerek yoktur.
