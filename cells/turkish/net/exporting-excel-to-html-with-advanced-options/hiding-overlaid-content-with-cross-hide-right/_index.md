...
4.  Örnek Excel Dosyası: Örneklerimizde kullanacağımız bir örnek Excel dosyası hazırlayın. Adlı bir örnek dosya oluşturun.`sampleHidingOverlaidContentWithCrossHideRightWhileSavingToHtml.xlsx`.
...
### Aspose.Cells'i nasıl satın alabilirim?
 Aspose.Cells'i şurayı ziyaret ederek satın alabilirsiniz:[satın alma sayfası](https://purchase.aspose.com/buy).
{{< /blocks/products/pf/tutorial-page-section >}}
