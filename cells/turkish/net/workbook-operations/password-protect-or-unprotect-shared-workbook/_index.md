...
3. Temel C# Bilgisi: C# programlama kavramlarına aşinalık, tartışacağımız kod örneklerini anlamanızı kolaylaştıracaktır.
...
Sonra, yeni bir çalışma kitabı örneği oluşturalım. Bu, daha sonra üzerinde işlem yapacağımız boş bir Excel dosyası bildirdiğimiz temel adımdır. 
```csharp
