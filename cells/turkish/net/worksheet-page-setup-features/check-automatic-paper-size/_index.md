...
2. Aspose.Cells Kütüphanesi: Aspose.Cells kütüphanesine sahip olduğunuzdan emin olun. Bunu şuradan indirebilirsiniz: [bu bağlantı](https://releases.aspose.com/cells/net/).
...
```csharp
// Otomatik kağıt boyutu yanlış olan ilk çalışma kitabını yükleyin
