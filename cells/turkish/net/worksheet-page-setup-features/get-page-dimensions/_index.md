---
title: Çalışma Sayfasının Sayfa Boyutlarını Al
linktitle: Çalışma Sayfasının Sayfa Boyutlarını Al
...
# Çalışma Sayfasının Sayfa Boyutlarını Al
...
## Adım 2: İlk Çalışma Sayfasına Erişim
 Sonra, çalışma kitabındaki ilk çalışma sayfasına erişelim. Varsayılan olarak, yeni bir çalışma kitabı bir sayfayla gelir, bu nedenle bir dizin kullanarak doğrudan ona başvurabiliriz`0`.
```csharp
...
### Aspose.Cells'de sayfanın yönünü nasıl değiştirebilirim?  
 Yönlendirmeyi kullanarak değiştirebilirsiniz.`PageSetup.Orientation` mülk, onu ikisinden birine ayarlayarak`PageOrientationType.Portrait` veya`PageOrientationType.Landscape`.
