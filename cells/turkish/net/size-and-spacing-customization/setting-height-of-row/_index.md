---
"description": "Bu adım adım kılavuzla Aspose.Cells for .NET'i kullanarak Excel'de satır yüksekliğini zahmetsizce ayarlamayı öğrenin."
...
## Paketleri İçe Aktar
Herhangi bir şey yapabilmemiz için önce Aspose.Cells'in çalışmasını sağlayan paketleri içe aktarmamız gerekiyor. İşte nasıl yapılacağı:
...
Şimdi eğlenceli kısma geliyoruz: Sıranın yüksekliğini ayarlama! 
```csharp
