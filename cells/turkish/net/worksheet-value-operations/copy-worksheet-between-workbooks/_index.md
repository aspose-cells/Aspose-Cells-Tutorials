---
title: Aspose.Cells kullanarak Çalışma Sayfasını Bir Çalışma Kitabından Diğerine Kopyalayın
linktitle: Aspose.Cells kullanarak Çalışma Sayfasını Bir Çalışma Kitabından Diğerine Kopyalayın
...
# Aspose.Cells kullanarak Çalışma Sayfasını Bir Çalışma Kitabından Diğerine Kopyalayın
...
1.  Aspose.Cells for .NET Kütüphanesi: Bu kütüphane, .NET'te Excel dosyalarıyla çalışmak için olmazsa olmazdır. İndirebilirsiniz[Burada](https://releases.aspose.com/cells/net/).
...
Aspose.Cells, çalışma sayfası için yazdırma ayarlarını tanımlamamızı sağlar. Burada, ilk beş satırı her yazdırılan sayfada tekrarlanacak şekilde ayarlayacağız; bu özellikle raporlar için kullanışlıdır.
```csharp
//Sayfa düzenini her sayfada başlık satırlarını tekrarlayacak şekilde yapılandırın.
PageSetup pagesetup = ws0.PageSetup;
pagesetup.PrintTitleRows = "$1:$5";
```
 Ayarlayarak`PrintTitleRows` ile`$1:$5`, ilk beş satırın (başlıklarımızın) her sayfada yazdırılmasını sağlarız. Bu özellik, büyük veri kümelerini yazdırırken bağlamı korumak için idealdir.
