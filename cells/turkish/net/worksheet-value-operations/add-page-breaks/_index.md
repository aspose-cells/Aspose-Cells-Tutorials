...
Sadece çağırarak birden fazla sayfa sonu ekleyebilirsiniz. `HveyaizontalPageBreaks.Add()` or `VerticalPageBreaks.Add()` yöntemleri farklı hücre referanslarıyla birden çok kez deneyin.
### Bir çalışma kitabının belirli bir çalışma sayfasına sayfa sonu ekleyebilir miyim?
...
Bir sayfa sonunu kaldırmak için şunu kullanabilirsiniz: `HveyaizontalPageBreaks.RemoveAt()` or `VerticalPageBreaks.RemoveAt()` Kaldırmak istediğiniz sayfa sonunun dizinini belirterek yöntemleri.
