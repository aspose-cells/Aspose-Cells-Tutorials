...
## SSS
### Aspose.Cells Nedir?
Aspose.Cells, .NET uygulamalarında Excel dosyalarıyla çalışmak için güçlü bir kütüphanedir ve çok sayıda düzenleme, dönüştürme ve hesaplama işlevi sunar.
### Aspose.Cells'i kullanmak ücretsiz mi?
Aspose.Cells ücretsiz deneme sunuyor, ancak deneme süresinin ötesinde kullanmak için bir lisans satın almanız gerekecek. Ayrıntılar için şu adresi ziyaret edin: [Aspose.Cells'i satın alın](https://purchase.aspose.com/buy).
