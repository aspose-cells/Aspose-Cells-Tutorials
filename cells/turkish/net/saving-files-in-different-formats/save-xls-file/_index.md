...
1. Çalışma kitabınızı kaydetmek için bu kodu kullanın:
   ...
   ```
Bu satır, programa çalışma kitabınızı "output.xls" adlı XLS formatında kaydetmesini söyler. `ContentDisposition.Inline` Bu bölüm, dosyanın ek olarak değil, doğrudan istemciye geri gönderilmesini sağlar.
